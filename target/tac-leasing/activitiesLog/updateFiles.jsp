...
<body>
<form action="${pageContext.request.contextPath}/servlet/defaultDispatcher?__action=activitiesLog.updateFiles" method="post" id="addForm" name="addForm" >
	...
	<input type="hidden" name="cust_id" id="cust_id" value="${activitiesLog.CUST_ID }">
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px">
	   		<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;" >&nbsp;&nbsp;修改主档(含<font color='red'>*</font>为必添项，请务必填写。)</span>
	   		</div>
	...
	<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
		...
		<tr id="3" class="ui-widget-content jqgrow ui-row-ltr">
			...
			<td><input type="text" style="height:25px" name="productsabout" id="productsabout" value="${activitiesLog.PRODUCTSABOUT }"/>&nbsp;</td>
			<td>引荐人：  <font color='red'>*</font></td>
			<td><input type="text" style="height:25px" name="referee" id="referee" value="${activitiesLog.REFEREE }"/>&nbsp;</td>
		</tr>
		<tr id="2" class="ui-widget-content jqgrow ui-row-ltr">
			<td>供应商：</td>
			<td><input type="text" style="height:25px" name="supplier" id="supplier"  value="${activitiesLog.SUPPLIER }"/>&nbsp;</td>
			<td>申请额度： </td>
			<td><input type="text" style="height:25px" name="limit" id="limit"   value="${activitiesLog.LIMIT }"/>&nbsp;</td>
		</tr>
		<tr>
			<td  colspan="4"><div align="center"><input class="ui-state-default ui-corner-all" type="button" id="buttonAdd" value="提交" onclick="updateFiles()"></input><input class="ui-state-default ui-corner-all" type="button" value="返回" onclick="javascript:history.go(-1);"></input></div></td>
