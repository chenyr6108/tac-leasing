...
<input type="hidden" name="__action" id="visit_form_action" value="visitCommand.doInputReport"/>
...
<table class="panel_table align_left" style="width: 800px;">
	...
	<tr>
		<th colspan="3" style="text-align: center!important;">
			<input type="button" value="暂存" onclick="visitReportSub(this);" class="panel_button"/>
			&nbsp;&nbsp;
...
<font color="red">
&nbsp;&nbsp;* “暂存”只会暂时保存当前报告，之后还可以做修改，不是最终报告。<br/>
