...
/* $(function (){
		if($("#LEASE_ALLPRIC").val().replace(/[￥,]/g, '')-$("#PAY_PLEDGE_PRICE").val().replace(/[￥,]/g, '')<100000) {
			$("#incomePay").val(2000);
...
<!-- Add by Michael 2012 01/14 费用参数化 -->
		...
		<tr>
			<td   class="ui-widget-content jqgrow ui-row-ltr">
				手续费收入：<input type="text" id="incomePay" name="incomePay" value='<fmt:formatNumber value="${incomePay }" pattern="##0.00"/>' readonly="readonly" style="width: 60px;color: black;border: 0">
			</td>
			<td  class="ui-widget-content jqgrow ui-row-ltr">
				手续费收入税额：<input type="text" id="incomePayTax" name="incomePayTax" value='<fmt:formatNumber value="${incomePay*0.055 }" pattern="##0.00"/>' readonly="readonly" style="width: 60px;color: black;border: 0">
			</td>
			<td class="ui-widget-content jqgrow ui-row-ltr">
				银行手续费：<input type="text" id="outPay" name="outPay" value='<fmt:formatNumber value="${outPay }" pattern="##0.00"/>' readonly="readonly" style="width: 60px;color: black;border: 0">
			</td>
