	...
	<table width="900" cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title" id="wuzd">
		...
		<tr>
			...
			<td style="text-align: left" class="ui-widget-content jqgrow ui-row-ltr">
				<input type="text" name="LEASE_ALLPRIC" id="LEASE_ALLPRIC" value="<fmt:formatNumber value="${schema.LEASE_ALLPRIC }" type="currency" />"
		...
		<tr>
			...
			<td   style="text-align:  left" class="ui-widget-content jqgrow ui-row-ltr">
				<input type="text" name="TOTAL_VALUEADDED_TAX" id="TOTAL_VALUEADDED_TAX" value="<fmt:formatNumber value="${empty schema.TOTAL_VALUEADDED_TAX ? 0 : schema.TOTAL_VALUEADDED_TAX }" type="currency" />"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</td>
		</tr>
		<tr>
			<td  class="ui-widget-content jqgrow ui-row-ltr">
