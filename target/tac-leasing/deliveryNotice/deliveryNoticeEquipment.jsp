...
<html>
  ...
  <body>
		 ...
		 <div class="zc_grid_body jqgrowleft">
  		...
  		<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
  			...
  			<c:forEach items="${equipList}" var="equipList" varStatus="status">
  				<tr class="ui-widget-content jqgrow ui-row-ltr">
  					<td style="text-align: center;"><input type="checkbox" name="eqmt_id" value="${equipList.EQMT_ID },${equipList.PUCT_CODE},${equipList.PUCT_ID}" id=eqmt_id /></td>
  					...
  					<td style="align:right"> <fmt:formatNumber value="${equipList.UNIT_PRICE }" type="currency"></fmt:formatNumber>&nbsp;</td>
  	...
  	<center>
  	<input type="button" class="ui-state-default ui-corner-all" value="确  定" onclick="subForm('eqmt_id')"; /><input type='button' class="ui-state-default ui-corner-all" value='返  回' onclick='javascript:history.go(-1)'   />
 </center> </body>
</html>
