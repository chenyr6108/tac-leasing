<%@ page language="java" import="java.util.*,com.brick.util.Constants" pageEncoding="UTF-8"%>
...
<html>
	...
	<body >
		<form id="addform" name="addform" action="../servlet/defaultDispatcher"
			method="post">
			<input type="hidden" name="__action" value="deliveryNoticeService.getDeliveryNoticeCreate">
			<input type="hidden" name="RECT_ID" value="${RECT_ID }" />
			<div style="margin:  1%;">
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px">
		   		<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;" >&nbsp;&nbsp;发货通知单</span>
		   	</div>
			...
			<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
				<tr>
					<td class="ui-widget-content jqgrow ui-row-ltr">合同编号 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${CODE}</td>
					<input type="hidden" name="DELV_CODE" id="DELV_CODE"  value="${deliveryCode }" />
				</tr>
			</table>
			<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
			...
			<tr><td colspan="9" class="ui-state-default ui-th-ltr zc_grid_head">付款信息</td></tr>
				...
				<tr class="ui-widget-content jqgrow ui-row-ltr">
					<td>付款说明</td>
					<td colspan="7"><textarea rows="2"  cols='140'  name="PAY_REMARK"  id="PAY_REMARK" /></textarea></td>
				</tr>
			</table>
			<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
			<tr><td colspan="9" class="ui-state-default ui-th-ltr zc_grid_head">发货信息</td></tr>
				<tr ><td class="ui-widget-content jqgrow ui-row-ltr">发货时间</td>
					<td class="ui-widget-content jqgrow ui-row-ltr"><input type="text" name="DELIVERY_DATE" id="datebegin"  value="${DELIVERY_DATE}" />
					</td><td colspan="2" class="ui-widget-content jqgrow ui-row-ltr">&nbsp;</td></tr>
				<tr><td class="ui-widget-content jqgrow ui-row-ltr">收货单位</td>
					<td class="ui-widget-content jqgrow ui-row-ltr"><input type="text" name="RECEIVING_UNIT"  id="RECEIVING_UNIT" size="20" value="${deliveryMap.RECEIVING_UNIT}" >
					</td><td colspan="2" class="ui-widget-content jqgrow ui-row-ltr">&nbsp;</td>
				</tr>
				<tr><td class="ui-widget-content jqgrow ui-row-ltr">收货地点</td>
					<td class="ui-widget-content jqgrow ui-row-ltr"><input type="text" name="RECEIVING_ADDR" id="RECEIVING_ADDR" size="20" value="${deliveryMap.DELIVERY_ADDRESS}"  >
					</td><td class="ui-widget-content jqgrow ui-row-ltr" colspan="2">&nbsp;</td></tr>
				<tr><td class="ui-widget-content jqgrow ui-row-ltr">开票单位</td>
					<td class="ui-widget-content jqgrow ui-row-ltr"><input type="text" name="BALLOT_UNIT" id="BALLOT_UNIT" size="20" value="${deliveryMap.BALLOT_UNIT}"  >
					</td><td class="ui-widget-content jqgrow ui-row-ltr" colspan="2">&nbsp;</td></tr>
				<tr><td class="ui-widget-content jqgrow ui-row-ltr">发货联系人</td>
					<td class="ui-widget-content jqgrow ui-row-ltr"><input type="text" name="DELIVERY_LINKMAN" id="DELIVERY_LINKMAN" size="20" value="${deliveryMap.SELLER_AGENT}"  /></td>
					<td class="ui-widget-content jqgrow ui-row-ltr">联系电话</td>
					<td class="ui-widget-content jqgrow ui-row-ltr"><input type="text" name="DELIVERY_LINKPHONE" id="DELIVERY_LINKPHONE" size="20" value="${deliveryMap.SELLER_PHONE}"   /></td>
				</tr>
				<tr><td class="ui-widget-content jqgrow ui-row-ltr">收货联系人</td>
					<td class="ui-widget-content jqgrow ui-row-ltr"><input type="text" name="RECEIVING_LINKMAN"  id="RECEIVING_LINKMAN" size="20"  value="${deliveryMap.BUYER_AGENT}" /></td>
					<td class="ui-widget-content jqgrow ui-row-ltr">联系电话 </td>
					<td class="ui-widget-content jqgrow ui-row-ltr"><input type="text" name="RECEIVING_LINKPHONE"  id="RECEIVING_LINKPHONE" size="20"  value="${deliveryMap.BUYER_PHONE}" /> </td>
				</tr>
				<tr class="ui-widget-content jqgrow ui-row-ltr"><td><%=Constants.COMPANY_NAME %>联系人 </td>
					<td><input type="text" name="FINANCELEASE_LINKMAN" id="FINANCELEASE_LINKMAN" size="20"  value="${deliveryMap.LINKMAN}"  /></td>
					<td>联系电话</td>
					<td><input type="text" name="FINANCELEASE_LINKPHONE"  id="FINANCELEASE_LINKPHONE" size="20"  value="${deliveryMap.LINKMAN_MOBILE}"  /> </td>
				</tr>
				<tr class="ui-widget-content jqgrow ui-row-ltr">
					<td>备注</td>
					<td colspan="7"><textarea rows="2"  cols='140' name="REMARK" id="REMARK"  ></textarea></td>
				</tr>
			</table>
			<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
			<tr><td colspan="9" class="ui-state-default ui-th-ltr zc_grid_head">签字信息</td></tr>
				<tr class="ui-widget-content jqgrow ui-row-ltr">
					<td>融资公司签字</td>
					<td><input type='text' name="FINANCELEASE_SIGN" id="FINANCELEASE_SIGN" /></td>
					<td>承租方签字</td>
					<td><input type='text' name="RECEIVING_SIGN" id="RECEIVING_SIGN" /></td>
					<td>厂商签字</td>
					<td><input type='text' name="DELIVERY_SIGN" id="DELIVERY_SIGN" /></td>
				</tr>
				<tr class="ui-widget-content jqgrow ui-row-ltr">
					<td>签字时间</td>
					<td><input type="text" name="FINANCELEASE_SIGNDATE" id="datebegin2"	/></td>
					<td>签字时间</td>
					<td><input type="text" name="RECEIVING_SIGNDATE" id="datebegin3" /></td>
					<td>签字时间</td>
					<td><input type="text" name="DELIVERY_SIGNDATE"  id="datebegin4" /></td></tr>
			</table>
			<center>
			<input type="button" name="sub" class="ui-state-default ui-corner-all" onclick="subNotice();" value="提  交" />
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
