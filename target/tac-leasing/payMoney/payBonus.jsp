...
function radioNull()
{
 ...
 function payMoneyPass(id,bankComp)
    {
    	location.href='${ctx }/servlet/defaultDispatcher?__action=payMoney.updatePayMoneyPass&ID='+id+'&Num=2&bankComp='+bankComp;
...
<form action="${pageContext.request.contextPath}/servlet/defaultDispatcher?__action=backMoney.createPayMoneyManager" method="post" id="addForm" name="addForm" >
	...
	<input type="hidden" name="backState" id="backState" value="2">
	...
	<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
			...
			<tr class="ui-widget-content jqgrow ui-row-ltr">
				<td>实际支付日：     <fmt:formatDate value='${payMoney.TIME }' pattern='yyyy-MM-dd'/></td>
