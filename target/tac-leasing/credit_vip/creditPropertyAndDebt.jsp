...
<img src="${ctx }/images/u103.gif" 
	...
	onclick="location.href='${ctx }/servlet/defaultDispatcher?__action=creditPriorRecordsVip.deleteCorpImg&img_id=${cropImg1.ID}'"/>
<img src="${ctx }/showImg?file_name=${cropImg1.FILE_PATH}" alt="BSPL-1" style="max-width: 500px;">
</div>
</c:otherwise>
</c:choose>
</html>