...
<html>
    ...
    <script type="text/javascript">
    	...
    	function checkFileType(){
    		var imageName = $("#upLoadFile").val().split("."); 
    		if(imageName !=""){
    			var imageType = imageName[1].toLowerCase() ;
    			if( imageType == "rar" || imageType == "jpg"  || imageType == "pdf" || imageType == "jpeg"|| imageType == "png"|| imageType == "tif") {
    				return true ;
    			}else {
    				alert("类型不符合请重新上传") ;
    				$("#upLoadFile").val("");
	...
	<form name="uploadForm" id="uploadForm" method="post" enctype="multipart/form-data">
		...
		上传文件：<input type="file" name="upLoadFile" size="40" style="height: 25px;" id="upLoadFile" onchange="checkFileType();"/>
