		...
		<c:forEach items="${corpProperty}" var="items" varStatus="s">
		  <c:if test="${item.PJCCC_ID eq items.VOUCH_ID }">
			...
			<tr class="ui-widget-content jqgrow ui-row-ltr">
				<td>房产名称</td>
				<td colspan="3"><input type="text" id="HOUSE_NAME" name="HOUSE_NAME" value="${items.HOUSE_NAME }"></td>
			</tr>
			<tr class="ui-widget-content jqgrow ui-row-ltr">
				<td>房产坐落地点</td>
				<td width="30%"><input style="width: 500" type="text" id="HOUSE_ADDRESS" name="HOUSE_ADDRESS" value="${items.HOUSE_ADDRESS }"></td>
				<td>面积</td>
			...
			<tr class="ui-widget-content jqgrow ui-row-ltr">
				<td>备注 </td>
				<td colspan="3"><textarea class="txtk" style="width: 500px; height: 50px; font-size: 12px" name="NOTES" id="NOTES">${items.NOTES }</textarea><img src="${ctx }/images/u103.gif">&nbsp;<a href="javaScript:location.href='${ctx }/servlet/defaultDispatcher?__action=creditVoucher.deleteCropProperty&credit_id=${prcd_id }&id=${items.ID }';">删除</a></td>
			</tr>
		  </c:if>
		</c:forEach>
		</table>
