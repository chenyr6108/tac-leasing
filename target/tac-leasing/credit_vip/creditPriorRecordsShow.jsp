	...
	<body>
		...
		<form action="../servlet/defaultDispatcher" name="riorRecordsForm" id="riorRecordsForm"
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0">
							...
							<tr>
								...
								<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title" >
										...
										<tr>
											...
											<td width="100%"><pre>${creditPriorFactoryBuld.REMARKCONTEXT }</pre></td>
					...
					<td>
						<table width="100%"cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title"   >
							<tr>
								...
								<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title" id="priorProjectEquipment">
										...
										<tr>
											...
											<td width="7%" class="ui-state-default ui-th-ltr zc_grid_head" align="center" >
												总计
											</td>
											<td width="18%" class="ui-state-default ui-th-ltr zc_grid_head" align="center" >
												备注说明
											</td>
										...
										<tr>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center">${item.EQUPNAME }</td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center">${item.EQUPNUM }</td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center">${item.EQUPMODEL }</td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center"><c:if test="${item.EQUPBUYDATE ne '1900-01-01' }">${item.EQUPBUYDATE}</c:if></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center"><fmt:formatNumber value="${item.EQUPBUYMON }" pattern="#,#00.00" /></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center"><fmt:formatNumber value="${item.EQUPBUYMON*item.EQUPNUM }" pattern="#,#00.00" /></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center"width="100%"><pre>${item.EQUPREMARK }</pre></td>
							...
							<tr >
								...
								<table>
									<td width="100%"><pre>${EuqipmentsRemarkMap.ALLREMARK }</pre></td>
						...
						<table width="100%"cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title"   >
							<tr>
								...
								<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title" id="table_ContactCoustomer">
										...
										<tr>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center">${item.CC_NAME }</td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center">${item.CC_ADDRESS }</td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center">${item.CC_TYPE }</td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center"><fmt:formatNumber value="${item.CC_MONEY }" pattern="#,#00.00" /></td>
											<c:set var="cc_all" value="${ item.CC_MONEY +cc_all }"></c:set>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center"><fmt:formatNumber value="${item.CC_PERCENT}" pattern="#00.00" /></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center">${item.CC_CONDITION }</td>
										...
										<tr>
											...
											<td colspan="2"  class="ui-state-default ui-th-ltr zc_grid_head" align="center" >&nbsp;</td>
										</tr>
							...
							<tr >
								...
								<td colspan="5" class="ui-state-default ui-th-ltr zc_grid_head" align="center" >
									<table>
									<td width="100%"><pre>${ContactCustomerRemarkMap.ALLREMARK }</pre></td>
						...
						<table width="100%"cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title"   >
							<tr>
								...
								<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title" id="priorProjectBuyFactory">
										...
										<!-- 加入总计 -->
										<tr>
											<td colspan="1"  class="ui-state-default ui-th-ltr zc_grid_head" align="center" >
												&nbsp;
											</td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center" >
												合计
											</td>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center"><fmt:formatNumber value='${BUYFACTORYOR_ALL}' pattern='#,#00.00' /></td>
											<td colspan="2"  class="ui-state-default ui-th-ltr zc_grid_head" align="center" >
												&nbsp;
											</td>
										</tr>
										...
										<tr >
											...
											<td colspan="5" class="ui-state-default ui-th-ltr zc_grid_head" align="center" >
											<table>
												<td width="100%"><pre><pre><c:forEach items="${BuyFactoriesList}" var="item" varStatus="status">${item.ALLBUYREMARK }</c:forEach></pre></td>
						...
						<table width="100%"cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title"   >
							...
							<tr>
								...
								<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title" id="priorProjectBankCheckBill">
										<tr >
											<td colspan="8" width="70%" class="ui-state-default ui-th-ltr zc_grid_head" align="left" >
												银行对账单(元)
											</td>
									...
									<tr >
										...
										<td colspan="8" class="ui-state-default ui-th-ltr zc_grid_head" align="center" >
										<table><td>
				...
				<tr>
					<td>
						<table width="100%" cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title"  id="priorRecordsTab">
							<tr>
								<td colspan="7" >
									<table  cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title" width="100%">
										<tr >
							...
							<c:forEach items="${creditPriorRecords}" var="item">
								<tr>
									...
									<td colspan="2" align="center" style="text-align: center" class="ui-widget-content jqgrow ui-row-ltr">
										${item.INFO_REMARK }  &nbsp;
									</td>
								</tr> 
							</c:forEach>
				...
				<tr>
					<td>
						<table width="100%" id="priorProjectTab" cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title" >
							<tr>
								<td colspan="2" class="ui-state-default ui-th-ltr zc_grid_head" width="100%">
									<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title" >
										<tr >
											<td class="ui-widget-content jqgrow ui-row-ltr" align="left" width="88%">
												过往项目
											</td>
							...
							<c:forEach items="${creditPriorProject}" var="item" varStatus="status">
								<c:if test="${item.STATE eq 0}">
									<tr>
										...
										<td width="81%" style="text-align: left" class="ui-widget-content jqgrow ui-row-ltr">
											${item.PROJECT_NAME } &nbsp;
										</td>
									</tr> 
									<tr>
				...
				<%-- <tr>
					<td>
						<table width="100%" id="thisProjectsTab"cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
							<tr>
								<td height="26" class="ui-state-default ui-th-ltr zc_grid_head">
									本次租赁意见总结
								</td>
			...
			<c:if test="${not empty memoList}">
				...
				<table cellspacing="0" cellpadding="0" border="0"  class="ui-jqgrid-htable zc_grid_title" id="#table1">
					...
					<c:forEach items="${memoList}" var="item" varStatus="status" >														
						<tr class="ui-widget-content jqgrow ui-row-ltr">
							...
							<td width="59" align="center" width="100%"><pre>${item.MEMO}</pre></td>
				...
				<tr>
					<td align="center">
						<input type="button" class="ui-state-default ui-corner-all" name="sub" value="下一页" onclick="javascript:location.href='${ctx }/servlet/defaultDispatcher?__action=creditVoucherVip.getCreditVouchersShow&credit_id=${creditMap.ID }&showFlag=4&examineFlag=${examineFlag}&commit_flag=${commit_flag}'"/>
