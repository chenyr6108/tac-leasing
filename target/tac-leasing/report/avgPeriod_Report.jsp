...
<html>
	...
	<body >
		<form id="addform" name="addform" action="../servlet/defaultDispatcher" method="post">
			<input type="hidden" name="__action" value="avgPeriodCommand.getReport">
			<input type="hidden" name="year" id="year" value="${year }">
			<input type="hidden" name="decp" id="decp" value="${decp }">
			<div style="margin:1%;">
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px">
		   		<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;" >&nbsp;&nbsp;平均租期图</span>
		   	</div>
	  		...
	  		<div class="ui-state-default ui-jqgrid-hdiv ">
	  			<table class="grid_table">
					<tr>
						...
						<th style="width: 60%;"><input type="button" value="添加" onclick="addOption();" style="width: 80px; height: 22px;"/></th>
					</tr>
				</table>
				<table class="grid_table">
					<tr>
						...
						<th style="width: 25%;">&nbsp;<input type="submit" value="生成图表" style="width: 80px; height: 22px;"> </th>
					</tr>
				</table>
	  			<div align="center">
			...
			<br>
	<span id="clock"></span>
	<p align="right" style="font-weight:bolder;">编号：IT-RPT-9</p>
	<script>
$(function () {
		var d=new Date();
