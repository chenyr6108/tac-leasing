...
<html>
	<head>
		...
		function expToExcel(){
		  $("#__action").val("insuranceReport.expValueAddTaxToExcel");
		  $("#form1").submit();
		  $("#__action").val("insuranceReport.valueAddTaxReport");
		}	
	...
	<body>
		<form action="../servlet/defaultDispatcher" name="form1" id="form1"
			...
			<input type="hidden" name="__action" id="__action"
				value="insuranceReport.valueAddTaxReport">
	
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px">
		   		<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;" >&nbsp;&nbsp;增值税明细表</span>
		   	</div>
