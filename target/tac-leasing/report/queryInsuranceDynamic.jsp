...
<html>
	<head>
		...
		function expToExcel(){
		  $("#__action").val("insuranceReport.expInsuranceDynamicToExcel");
		  $("#form1").submit();
		  $("#__action").val("insuranceReport.insuranceDynamicReport");
		}			
		$(function (){
	...
	<body>
		<form action="../servlet/defaultDispatcher" name="form1" id="form1"
			...
			<input type="hidden" name="__action" id="__action"
				value="insuranceReport.insuranceDynamicReport">
			...
			<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
				...
				<c:forEach items="${dw.rs}" var="item">
					<tr class="ui-widget-content jqgrow ui-row-ltr">   
						...
						<td style="text-align: center;"><fmt:formatNumber value="${item.QCYE }" type="currency" />&nbsp;</td>
						<td style="text-align: center;"><fmt:formatNumber value="${item.BQXZ }" type="currency" />&nbsp;</td>
						<td style="text-align: center;"><fmt:formatNumber value="${item.MONTHINSURANCE }" type="currency" />&nbsp;</td>	
						<td style="text-align: center;"><fmt:formatNumber value="${item.QMYE }" type="currency" />&nbsp;</td>
					</tr>
				</c:forEach>
			</table>
