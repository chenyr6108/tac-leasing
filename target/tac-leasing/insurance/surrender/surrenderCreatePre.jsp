	...
	<body >
		<form id="addform" name="addform" action="../servlet/defaultDispatcher" method="post">
			...
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px">
		   		<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;" >&nbsp;&nbsp;添加退保信息</span>
		   	</div>
			...
			<tr>
				<tr class="ui-widget-content jqgrow ui-row-ltr">
					...
					<td style="text-align: left;height:24px;width:25%;"><input onfocus="this.value=''"  type="text" name="SURRENDER_DATE" id="DANG_DATE">&nbsp;</td>
					<th style="text-align: left;height:24px;width:25%;" class="ui-state-default ui-th-ltr zc_grid_head">退保金额(元)：</th>
					<td style="text-align: left;height:24px;width:25%;"><input   type="text" name="SURRENDER_PRICE" id="SURRENDER_PRICE" onkeyup="checkNum(this)"><font color="red" size="5">*</font></td>
				</tr>
				<tr class="ui-widget-content jqgrow ui-row-ltr">
				...
				<tr class="ui-widget-content jqgrow ui-row-ltr">
					...
					<td colspan="5"><textarea rows="3" cols="150" name=SURRENDER_REASON>${satisfaction.REMARK }无</textarea><font color="red" size="5">*</font></td>
