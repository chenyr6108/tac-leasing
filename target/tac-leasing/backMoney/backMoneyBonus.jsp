...
<html>
	...
	<body>
		<form id="form1" name="form1" method="POST"  action="${ctx}/servlet/defaultDispatcher">
			<input type="hidden" name="__action" id="__action" value="backMoney.queryRentContractBackMoneyByBonus" />
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px">
		   		<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;" >&nbsp;&nbsp;奖金拨款管理</span>
		   	</div>
	          	...
	          	<table width="97%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
				      ...
				      <td width="8">&nbsp;</td>
				        ...
				        <td width="60%" class="ss_t" valign="top">
				          ...
				          <tr>
				          <td>查询内容：</td>
				          <td colspan="7"><input type="text" name="content" value="${content }" 
				...
				<div class="ui-state-default ui-jqgrid-hdiv ">
					<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title" id="#table1">
							...
							<tbody>
								<c:forEach items="${dw.rs}" var="item" varStatus="status">													
									<tr class="ui-widget-content jqgrow ui-row-ltr">
										<td style="text-align: center;" onClick="exMoneyBonusJoin('contractTr${item.ID }','${item.ID }','manage');"><c:if test="${item.STATUS==0 and item.STATE==3 }"><img src="${ctx }/images/u611.gif" title="完成拨款"></c:if><c:if test="${item.STATUS==0 and (item.STATE==0 or item.STATE==1)}"><img src="${ctx }/images/u608.gif" title="审核中"></c:if><c:if test="${item.STATUS==1 }"><img src="${ctx }/images/u622.gif" title="驳回"></c:if></td>
						...
						<td style='text-align: center;height: 25px;'><fmt:formatDate value="${item.PAY_DATE }" pattern="yyyy-MM-dd"/>&nbsp;</td>	
										...
										<td style="text-align: center;"><a href="javaScript:void(0);" onclick="pdfFun('${item.ID }')">导出付款凭证</a></td>
									</tr>
