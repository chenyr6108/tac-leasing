...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function backPage(){
				$("#__action").val("backMoney.queryHandlingCharge");
				$("#form1").submit();
			}
			
			function doPay(){
				$("#__action").val("backMoney.doPayHandlingCharge");
				$("#form1").submit();
			}
	...
	<body>
		<form id="form1" name="form1" method="POST"  action="${ctx}/servlet/defaultDispatcher">
			<input type="hidden" name="__action" id="__action" value="backMoney.delItemFromCart" />
			...
			<div class="ui-state-default ui-jqgrid-hdiv ">
				...
				<table class="grid_table">
					...
					<c:forEach items="${resultList}" var="item" varStatus="status">	
						...
						<c:set var="outPayTotal" value="${outPayTotal + item.OUT_PAY }"/>
					</c:forEach>
					<tr>
