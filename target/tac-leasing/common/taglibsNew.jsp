...
<script type="text/javascript" src="${ctx }/resources/jquery/new/js/jquery-1.8.3.min.js"></script>
<script type="text/javascript" src="${ctx }/common/js/date.js"></script>
<script type="text/javascript" src="${ctx }/resources/jquery/new/js/jquery-ui-1.10.4.custom.min.js"></script>
...
<script type="text/javascript" src="${ctx }/common/js/gridTableNew.js"></script>
<script type="text/javascript" src="${ctx }/common/js/ichart.1.1.min.js"></script>	

<link type="text/css" href="${ctx }/resources/jquery/new/css/redmond/jquery-ui-1.10.4.custom.min.css?v=1" rel="stylesheet" />	
