...
(function($) {
	...
	$.widget("ui.weekCalendar", {
	    ...
	    _renderCalendar : function() {
	        ...
	        //--by zxb
	        var calendarDayHtml  = "<div class=\"calendar-day-grid\"><table class=\"week-calendar-day-slots\">\
	            <tbody>\
	            <tr >\
	            <td class=\"grid-dayslot-header\" ></td>\
	            <td colspan=\"7\">\
	            <div class=\"time-slot-wrapper\">\
	            <div class=\"time-slots\" ><div class=\" \" style='height:50px'>";
	            
	        calendarDayHtml += "</div></div></div></td></tr>";
	        
	        calendarDayHtml += '<tr height=\"99px\"><td class="grid-dayslot-header"></td>\
									<td class="day-column hour-end day-1"></td>\
									<td class="day-column hour-end day-2"></td>\
									<td class="day-column hour-end day-3"></td>\
									<td class="day-column hour-end day-4"></td>\
									<td class="day-column hour-end day-5"></td>\
									<td class="day-column hour-end day-6"></td>\
									<td class="day-column hour-end day-7"></td>';
									
	        //calendarDayHtml += "<td class=\"scrollbar-shim\"></td></tr>";
	        calendarDayHtml += "</tbody></table></div>";
	        //
	                    
	        //render calendar body
	        calendarBodyHtml = "<div class=\"calendar-scrollable-grid\">"
	        
	        calendarBodyHtml +=  "<div id='drag'><table class=\"week-calendar-time-slots\">\
	            <tbody>\
	            <tr>\
	        ...
	        $(calendarHeaderHtml + calendarDayHtml + calendarBodyHtml).appendTo($calendarContainer);
