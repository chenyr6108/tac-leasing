...
<html>
	...
	<body>
		<form action="../servlet/defaultDispatcher" name="form1" id="form1" method="post">
			<input type="hidden" name="__action" id="__action" value="supportCreditReportDelete.creditManageForGuarantor">
			<input type="hidden" id="credit_id" name="credit_id">	
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px">
		   		<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;" >&nbsp;&nbsp;报告担保人维护</span>
		   	</div>
			...
			<div style="margin: 6 0 6 0px;">
	          	<table width="97%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
					...
					<c:if test="${credit_type eq 0}">
						<c:set var="type0" value="selected='selected'
						"></c:set>
					</c:if>
			...
			<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
				...
				<c:forEach items="${dw.rs}" var="item">
					<tr class="ui-widget-content jqgrow ui-row-ltr">
						...
						<a href="javaScript:void(0)" onclick="javascript:location.href='${ctx }/servlet/defaultDispatcher?__action=creditVoucher.getCreditVouchersShowForSupport&credit_id=${item.ID }&commit_flag=1'">查看</a>|
						<a href="javaScript:void(0)" onclick="javaScript:location.href='${ctx }/servlet/defaultDispatcher?__action=creditVoucher.getCreditVouchersShowForSupport&credit_id=${item.ID }&commit_flag=2'">修改</a>
						</td>
					</tr>
				</c:forEach>
			</table>
