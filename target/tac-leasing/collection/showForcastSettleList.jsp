...
<html>
	...
	<body>
			...
			<input type="hidden" name="__action" value="settleManage.expForcastSettlePDF"> 
											...
											<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
												...
												<tr >
													...
													<tr>
														...
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															<input type="text" id="REAL_SUM_VALUE_ADDED_TAX" name="REAL_SUM_VALUE_ADDED_TAX" onchange="changeRealTotal()" value="<fmt:formatNumber value="${settleMap.SUM_VALUE_ADDED_TAX}" type="currency" />" readonly="readonly"/>
														</td>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
													...
													<tr>
														...
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															...
															<input type="hidden" id="OWN_PRICE" name="OWN_PRICE" value="<fmt:formatNumber value="${settleMap.SUM_OWN_PRICE}" type="currency" />" readonly="readonly"/>
														</td>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															<input type="text" id="REAL_OWN_PRICE" name="REAL_OWN_PRICE" onchange="changeRealTotal()" value="<fmt:formatNumber value="${settleMap.SUM_OWN_PRICE}" type="currency" />" readonly="readonly"/>
														</td>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
														...
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															<input type="text" id="CASH" name="CASH" value="" readonly="readonly"/>
														</td>
													</tr>
													<tr>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
														...
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															...
															<input type="hidden" id="REN_PRICE" name="REN_PRICE" value="<fmt:formatNumber value="${settleMap.SUM_REN_PRICE}" type="currency"/>" readonly="readonly"/>
														</td>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															<input type="text" id="REAL_REN_PRICE" name="REAL_REN_PRICE" onchange="changeRealTotal() ;" value="<fmt:formatNumber value="${settleMap.SUM_REN_PRICE}" type="currency"/>" readonly="readonly"/>
														</td>
													<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
														...
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															<input type="text" id="NOTE" name="NOTE" value="" readonly="readonly"/>
														</td>	
													</tr>
													<tr>
													<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
													...
													<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
														...
														<input type="hidden" id="DUN_PRICE" name="DUN_PRICE" onchange="changeRealTotal() ;" value="<fmt:formatNumber value="${settleMap.DUN_PRICE}" type="currency"/>" readonly="readonly"/>
													</td>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															<input type="text" id="REAL_DUN_PRICE" name="REAL_DUN_PRICE" onchange="changeRealTotal() ;" value="<fmt:formatNumber value="${settleMap.DUN_PRICE}" type="currency" />" readonly="readonly"/>
														</td>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
														...
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															<input type="text" id="OTHER" name="OTHER" value="" readonly="readonly"/>
														</td>																																			
													</tr>	
													<tr>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
														...
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															...
															<input type="hidden" id="BREACH_PRICE" name="BREACH_PRICE" value="<fmt:formatNumber value="${weiYueJin}" type="currency" />" readonly="readonly"/>
														</td>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															<input type="text" id="REAL_BREACH_PRICE" name="REAL_BREACH_PRICE" onchange="changeRealTotal() ;" value="<fmt:formatNumber value="${weiYueJin}" type="currency" />" readonly="readonly"/>
														</td>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
													...
													<tr>
														...
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															...
															<input type="hidden" id="DAMAGE_PRICE" name="DAMAGE_PRICE" value="<fmt:formatNumber value="${sunHaiJin}" type="currency" />" readonly="readonly"/>
														</td>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															<input type="text" id="REAL_DAMAGE_PRICE" name="REAL_DAMAGE_PRICE" onchange="changeRealTotal() ;" value="<fmt:formatNumber value="${sunHaiJin}" type="currency" />" readonly="readonly"/>
														</td>
													<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
													...
													<tr>
														...
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															...
															<input type="hidden" id="STAYBUY_PRICE" name="STAYBUY_PRICE" value="<fmt:formatNumber value="${settleMap.LGJ}" type="currency" />" readonly="readonly"/>
														</td>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															<input type="text" id="REAL_STAYBUY_PRICE" name="REAL_STAYBUY_PRICE" onchange="changeRealTotal() ;" value="<fmt:formatNumber value="${settleMap.LGJ}" type="currency" />" readonly="readonly"/>
														</td>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
													...
													<tr>
														...
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															...
															<input type="hidden" id="OTHER_PRICE" name="TOTAL_LAWYFEE" value="<fmt:formatNumber value="${settleMap.TOTAL_LAWYFEE}" type="currency" />" readonly="readonly"/>
														</td>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															<input type="text" id="REAL_OTHER_PRICE" name="REAL_TOTAL_LAWYFEE" onchange="changeRealTotal() ;" value="<fmt:formatNumber value="${settleMap.TOTAL_LAWYFEE}" type="currency" />" readonly="readonly"/>
														</td>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
													...
													<tr>
														...
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															...
															<input type="hidden" id="OTHER_PRICE" name="OTHER_PRICE" value="<fmt:formatNumber value="${qiTa}" type="currency" />" readonly="readonly"/>
														</td>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															<input type="text" id="REAL_OTHER_PRICE" name="REAL_OTHER_PRICE" onchange="changeRealTotal() ;" value="<fmt:formatNumber value="${qiTa}" type="currency" />" readonly="readonly"/>
														</td>
													<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
													...
													<tr>
														...
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															...
															<input type="hidden" id="TOTAL" name="TOTAL" value="<fmt:formatNumber value="${settleMap.SUM_VALUE_ADDED_TAX+settleMap.SUM_OWN_PRICE + settleMap.SUM_REN_PRICE + settleMap.LGJ+settleMap.DUN_PRICE+settleMap.TOTAL_LAWYFEE}" type="currency" />" readonly="readonly"/>
														</td>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
															<input  type="text" id="REAL_TOTAL" name="REAL_TOTAL" onchange="changeRealTotal() ;" value="<fmt:formatNumber value="${settleMap.SUM_VALUE_ADDED_TAX+settleMap.SUM_OWN_PRICE + settleMap.SUM_REN_PRICE + settleMap.LGJ+settleMap.DUN_PRICE+settleMap.TOTAL_LAWYFEE}" type="currency" />" readonly="readonly"/>
														</td>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
									...
									<tr>
										<td>
											<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
												...
												<tr >
													...
													<td  style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
														<input type="text" name="BACKOUT_COUNT" readonly="readonly">
													</td>
													<td  style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
														票面总额：
													</td>
													<td  style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
														<input type="text" name="BACKOUT_TOTAL" readonly="readonly">
													</td>
												</tr>
													<tr>
														<td style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
										...
										<td>
											<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
												...
												<tr >
													<td align="center" colspan="2" style="text-align: left ;height: 24px;" class="ui-widget-content jqgrow ui-row-ltr">
														未收款金额：<input type="text" name="NOT_RECEIVED_PRICE" readonly="readonly">
													</td>
												</tr>
											</table>
										</td>
