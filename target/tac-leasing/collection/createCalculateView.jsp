	...
	<body>
		<center>
			...
			<form action="${ctx }/servlet/defaultDispatcher">
				<input type="hidden" name="_FIRST_PAYDATE" value="${FIRST_PAYDATE }">
				<input type="hidden" name="_START_DATE" value="${START_DATE }">
				<input type="hidden" name="_RECT_ID" value="${RECT_ID }">
				<!-- collectionManage.saveCalculate -->
				<input type="hidden" name="__action" value="rentContract.repayment">
				<br>
