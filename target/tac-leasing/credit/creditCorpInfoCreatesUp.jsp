...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
			...
			<table cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title">
				<tr>
					<td width="100%">
						<table width="100%" id="bankTab1${status.index }" cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title">
							<tr>
							...
							<c:if test="${fn:length(corpBankAccount) >1}">
								<tr class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
									<td rowspan="${fn:length(corpBankAccount)}" id="bankTd" style="text-align: left" class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">其他账户</td>
								</tr>
							</c:if>
							<c:forEach items="${corpBankAccount}" var="itemss">
				...
				<tr>
					<td width="100%">
						<table width="100%" cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" id="shareholderTab1${status.index }">
							<tr>
								<td colspan="5" class="ui-state-default ui-th-ltr zc_grid_head">
							...
							<tr>
								<td width="3%" class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
							...
							<c:forEach items="${corpSharholder}" var="itemss">
								<tr class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;"> 
									...
									<td  style="text-align: center;font-size: 14px;" class="ui-widget-content jqgrow ui-row-ltr"><input type="text" name="HOLDER_CAPITAL" id="HOLDER_CAPITAL${status.index }"
									...
									<td  style="text-align: center;font-size: 14px;"  class="ui-widget-content jqgrow ui-row-ltr"><input type="text" name="HOLDER_RATE" id="HOLDER_RATE${status.index }"
