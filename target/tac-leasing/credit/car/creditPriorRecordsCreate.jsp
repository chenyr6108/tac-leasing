...
<html>
	<head>
		...
		<script src="${ctx }/credit/car/js/creditPriorRecords.js" type="text/javascript"></script>
		...
		<script type="text/javascript">				
			...
			function gotoUploadPage() {
				...
				if(confirm("导入Excel前请先保存当前页面,否则数据会丢失!!")) {
					$("#updateDiv").dialog({modal:true,autoOpen:false,width:800});
			...
			function checkFormat() {
				var format=$("#excel").val().split(".");
				var typeName=format[1];
				alert(typeName)
				if("xls"!=typeName) {
	 				alert("只能上传excel文件");
	             	return;
			...
			//进货厂商照会记录  add by ShenQi 2012-7-12
			function addStock() {
				var tab=document.getElementsByName("table_stock");
				var sed=tab.length;
				$("#td_stock").append("<table name='table_stock' id='table_stock"+sed+"' class='ui-jqgrid-htable zc_grid_title' border='0'>"+
										"<tr>"+
											"<td class='ui-widget-content jqgrow ui-row-ltr' colspan='2'><b>基准日:</b><input id='STOCK_BASE_DATE"+sed+"' name='STOCK_BASE_DATE' readonly='readonly'></td>"+
											"<td class='ui-widget-content jqgrow ui-row-ltr' colspan='4' align='right'><input type='checkbox' name='STOCK_DEL' id='STOCK_DEL"+sed+"' value='"+sed+"'></td>"+
										"</tr>"+
										"<tr>"+
											"<td class='ui-widget-content jqgrow ui-row-ltr'>公司名称</td><td class='ui-widget-content jqgrow ui-row-ltr'><input id='STOCK_COMPANY"+sed+"' name='STOCK_COMPANY'></td>"+
											"<td class='ui-widget-content jqgrow ui-row-ltr'>联络电话</td><td class='ui-widget-content jqgrow ui-row-ltr'><input id='STOCK_PHONE"+sed+"' name='STOCK_PHONE'></td>"+
											"<td class='ui-widget-content jqgrow ui-row-ltr'>联络人</td><td class='ui-widget-content jqgrow ui-row-ltr'><input id='STOCK_LINK_MAN"+sed+"' name='STOCK_LINK_MAN'></td>"+
										"</tr>"+
										"<tr>"+
											"<td class='ui-widget-content jqgrow ui-row-ltr'>照会日期</td><td class='ui-widget-content jqgrow ui-row-ltr'><input id='STOCK_MEET_DATE"+sed+"' name='STOCK_MEET_DATE' readonly='readonly'></td>"+
											"<td class='ui-widget-content jqgrow ui-row-ltr'>往来产品</td><td class='ui-widget-content jqgrow ui-row-ltr'><input id='STOCK_PRODUCTION"+sed+"' name='STOCK_PRODUCTION'></td>"+
											"<td class='ui-widget-content jqgrow ui-row-ltr'>往来期间</td><td class='ui-widget-content jqgrow ui-row-ltr'><input id='STOCK_PERIOD"+sed+"' name='STOCK_PERIOD'></td>"+
										"</tr>"+
										"<tr>"+
											"<td class='ui-widget-content jqgrow ui-row-ltr'>往来金额</td><td class='ui-widget-content jqgrow ui-row-ltr'><input id='STOCK_MONEY"+sed+"' name='STOCK_MONEY'></td>"+
											"<td class='ui-widget-content jqgrow ui-row-ltr'>往来条件</td><td class='ui-widget-content jqgrow ui-row-ltr' colspan='3'><input id='STOCK_CONDITION"+sed+"' name='STOCK_CONDITION'></td>"+
										"</tr>"+
										"<tr>"+
											"<td class='ui-widget-content jqgrow ui-row-ltr' colspan='6'>照会内容</td>"+
										"</tr>"+
										"<tr>"+
											"<td class='ui-widget-content jqgrow ui-row-ltr' colspan='6'><textarea rows='3' cols='180' id='STOCK_CONTENT"+sed+"' name='STOCK_CONTENT'></textarea></td>"+
										"</tr>"+
									  "</table>");
				$("input[name='STOCK_BASE_DATE']").datepicker($.datepicker.regional['zh-CN']);
				$("input[name='STOCK_MEET_DATE']").datepicker($.datepicker.regional['zh-CN']);
			}
			
			function delStock() {
				var check=document.getElementsByName("STOCK_DEL");
				for(var i=check.length-1;i>=0;i=i-1) {
					if(check[i].checked==true) {
						$("#riorRecordsForm").append("<input type='hidden' name='table_stock'>");//为了防止添加table时候重复使用已经删除过的id
						$("#table_stock"+check[i].value).remove();
					}
				}
			}
			...
			function changeFont(param) {
				if(param==1) {
					$("#FONT_SHOW").html('银行贷款（元）');
				} else if(param==2) {
					$("#FONT_SHOW").html('每月租金（元）');
				}
			}
		</script>
	</head>
	...
	<body>
		...
		<form action="../servlet/defaultDispatcher" name="riorRecordsForm" id="riorRecordsForm"
			...
			<input type="hidden" name="__action"
				...
				<input type="hidden" name="credit_id" value="${creditMap.ID }" id="credit_id">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="5">
				<tr>
					<td>
						<table width="100%" id="priorRecordsTab" cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title">
							<tr>
								<td colspan="7"   class="ui-state-default ui-th-ltr zc_grid_head" style="font-size: 14px;">
										...
										<c:forEach items="${priorContractInfo}" var="item">
											<tr>
												...
												<td align="center"   class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
													<fmt:formatDate value="${item.LESSOR_TIME}" pattern="yyyy-MM-dd" /> &nbsp;
												</td>
												<td align="center"   class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
													${item.RECP_CODE } &nbsp;
												</td>
												...
												<td align="center"   class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
													...
													<c:if test="${item.LEASE_TERM eq 12 }" >年</c:if>  &nbsp;
												</td>
												<td align="right"   class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
												 <fmt:formatNumber value="${item.TOTAL_PRICE }" pattern="#,#00.00"/>  &nbsp;
												</td>
												<td align="right"   class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
													<fmt:formatNumber value="${item.MONTH_PRICE }" pattern="#,#00.00"/> &nbsp;
												</td>
												<td align="right"   class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
													 <fmt:formatNumber value="${item.TOTAL_REN }" pattern="#,#00.00"/>   &nbsp; 
												</td>
												<td align="right"   class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
													<fmt:formatNumber value="${item.OWN_PRICE }" pattern="#,#00.00"/>  &nbsp;
												</td>
												<td align="center"   class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
													<c:if test="${empty item.HAS_DUN }">无</c:if>
													<c:if test="${not empty item.HAS_DUN }">有</c:if>
												</td>
											</tr>
										</c:forEach>	
									</table> --%>
							...
							<tr>
								<td colspan="7"   class="ui-state-default ui-th-ltr zc_grid_head" style="font-size: 14px;">
								<br><br><br>
									<table cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" width="100%" id="beforerecords">
										<tr>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="left" width="75.5%">
										        <strong style="font-size: 14px;">过往记录</strong>
										   </td>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="right" style="font-size: 14px;">
													相关操作：
							...
							<tr>
								...
								<th width="14%" class="ui-state-default ui-th-ltr zc_grid_head" style="font-size: 14px;">供应商 
								</th>
							...
							<c:forEach items="${creditPriorRecords}" var="item">
								<tr>
									...
									<td colspan="2" align="center"  class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
				...
				<tr>
									...
									<table cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" >
										...
										<tr >
											<td colspan="3" class="ui-state-default ui-th-ltr zc_grid_head" align="left">
												<strong style="font-size: 14px;">厂房概况(乙式)</strong>
											</td>
					...
					<tr>
					<td>
						<table width="100%"cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" id="factorytable"  >
							<tr>
								<td colspan="6"  width="100%">
								<table cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" id="factoryinfotable">
										<tr >
											...
											<td  class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;" id="FONT_SHOW">
										...
										<tr >
											<td  class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
												<input onclick="changeFont('1')" type="radio" id="FBTYPE" name="FBTYPE" value="1" <c:if test="${creditPriorFactoryBuld.FBTYPE eq 1 }">checked="ture"</c:if>>自有/<input onclick="changeFont('2')" type="radio" id="FBTYPE" name="FBTYPE" value="0" <c:if test="${creditPriorFactoryBuld.FBTYPE eq 0 }">checked="ture"</c:if>>租赁
											</td>
											<td  class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
								...
								<br><br><br>
									<table cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" >
										...
										<tr >
											...
											<td style="text-align: center;font-size:14px;" class="ui-state-default ui-th-ltr zc_grid_head" align="center" >
										...
										<tr >
											...
											<td  class="ui-state-default ui-th-ltr zc_grid_head" colspan="4">
												<textarea rows="3" cols="100" style="margin-left: 87px;font-size:14px;" name="benefit_remark">${submitMachineMap.REMARK }</textarea>
											</td>
										</tr>
									</table>
								</td>
							...
							<tr>
								...
								<table cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" id="priorProjectEquipment">
										<tr >
											...
											<td colspan="2" width="20%" class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
												相关操作：
												<img src="${ctx }/images/u100.gif">
												&nbsp;
										...
										<tr>
											<td width="25%"  class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
												设备名称
											</td>
											<td width="8%" class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
												数量
											</td>
											<td width="20%" class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
												厂牌
											</td>
											<td width="10%" class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
												购入日期
											</td>
											<td width="10%" class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
												购入单价
											...
											<td width="23%" class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
												备注说明
											</td>
											<td width="3%" class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
										...
										<tr>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="text" size="35" name="sequipmentname" id="sequipmentname${ status.count }" value="${item.EQUPNAME }" style="text-align: center" size="10"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="text" onchange="getTotalMoney();" name="sequipmentnum" id="sequipmentnum${ status.count }" value="${item.EQUPNUM }" style="text-align: center" size="10"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="text" size="30" name="sequipmentmaker" id="sequipmentmaker${ status.count }" value="${item.EQUPMODEL }" style="text-align: center" size="10"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="text" name="sequipmentdate" id="sequipmentdate${ status.count }" <c:if test="${item.EQUPBUYDATE == '1900-01-01'}">value=""</c:if><c:if test="${item.EQUPBUYDATE != '1900-01-01'}">value="${item.EQUPBUYDATE }"</c:if> style="text-align: center" size="10"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="text" onchange="getTotalMoney();" name="sequipmentmoney" id="sequipmentmoney${ status.count }" value="<fmt:formatNumber value='${item.EQUPBUYMON }' pattern="#,#00.00" />" style="text-align: center" size="10"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="left" style="font-size: 14px;"><input type="text" name="sequipmentmoneyAll" id="sequipmentmoneyAll${ status.count }" size="10" readonly="readonly" value="<fmt:formatNumber value='${item.EQUPNUM*item.EQUPBUYMON }' pattern='#,#00.00' />"></td>
											<c:set var="all" value="${ item.EQUPNUM*item.EQUPBUYMON +all }"></c:set>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="text" size="35" name="sequipmentramark" id="sequipmentramark${ status.count }" value="${item.EQUPREMARK }" size="8"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="checkbox" name="sequipmentorder" id="sequipmentorder${ status.count }" value="${ status.count }"></td>
										</tr>
										</c:forEach>
										...
										<tr>
											...
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="left" style="font-size: 14px;"><input type="text" size="10" name="sequipmentmoney_total_all" id="sequipmentmoney_total_all" value="<fmt:formatNumber value='${all}' pattern='#,#00.00' />" size="10" readonly="readonly"></td>
										</tr>
				...
				<tr>
					<td>
						<!-- ***************************************************************************************************************************** -->
						<!-- 主要往来客户修改为丙式报告中的,进货厂商照会记录,销货厂商照会记录 add by ShenQi 2012-7-11 -->
						<br><br><br>
						<table width="100%"cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title"   >
							<tr>
								<td colspan="6"  width="100%">
								<table cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" id="table_ContactCoustomer">
										<tr >
											<td colspan="3" width="70%" class="ui-state-default ui-th-ltr zc_grid_head" align="left" style="font-size: 14px;">
												主要销货客户（仟元）
											</td>
											<td colspan="2" width="20%" class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
												相关操作：
										...
										<tr>
											...
											<td width="15%" class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
												联系人
											</td>
											<td width="15%" class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
												电话
											</td>
											<td width="4%" class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
										...
										<tr>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="text" size="35"   name="cc_name" id="cc_name${ status.count }" value="${item.CC_NAME }" style="text-align: center"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="text" name="cc_address" id="cc_address${ status.count }" value="${item.CC_ADDRESS }" style="text-align: center" size="10"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="text" size="30" name="cc_type" id="cc_type ${ status.count }" value="${item.CC_TYPE }" style="text-align: center"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="text" onchange="CCPerAndSum('${ status.count }')" name="cc_money" id="cc_money${ status.count }"  value="<fmt:formatNumber value='${item.CC_MONEY }' pattern='#,#00.00' />" style="text-align: center" size="10"></td>
											<c:set var="cc_all" value="${ item.CC_MONEY +cc_all }"></c:set>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="text" name="cc_percent" id="cc_percent${  status.count }"  value="<fmt:formatNumber value='${item.CC_PERCENT }' pattern='#,#00.00' />" style="text-align: center" size="10"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="text" size="35" name="cc_condition" id="cc_condition ${ status.count }" value="${item.CC_CONDITION }"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="text" size="20" name="cc_link_man" id="cc_link_man${ status.count }" value="${item.CC_LINK_MAN }"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="text" size="20" name="link_man_phone" id="link_man_phone status.count }" value="${item.LINK_MAN_PHONE }"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="checkbox" name="cc_order" id="cc_order${ status.count }" value="${ status.count }"></td>
										</tr>
										</c:forEach>

										<!-- 加入总计 -->
										<tr>
											<td colspan="6"  class="ui-state-default ui-th-ltr zc_grid_head" align="center" >
												&nbsp;
											</td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
												合计
											</td>
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="text" size="35" name="cc_all" id="cc_all" value="<fmt:formatNumber value='${cc_all}' pattern='#,#00.00' />" size="8"></td>
										</tr>
						...
						<%-- <table width="100%" cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title">
							<tr>
								<td colspan="6" width="100%" id="td_stock">
									<table cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title">
										<tr>
											...
											<td colspan="2" width="20%" class="ui-state-default ui-th-ltr zc_grid_head" align="center">
												...
												<img src="${ctx }/images/u100.gif">
												&nbsp;
												<a href="javaScript:void(0);" onclick="addStock()">添加</a>
											</td>
											<td colspan="2" class="ui-state-default ui-th-ltr zc_grid_head" align="right">
												<img src="${ctx }/images/u103.gif">
												&nbsp;
												<a href="javaScript:void(0);" onclick="delStock()">删除</a>
											</td>
										</tr>
									</table>
								</td>
						...
						<c:forEach items="${stockCompanyList}" var="item" varStatus="status">
							<table name='table_stock' id='table_stock${status.count-1 }' width="100%" cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title">
								<tr>
									<td class='ui-widget-content jqgrow ui-row-ltr' colspan='2'><b>基准日:</b><input name='STOCK_BASE_DATE' id='STOCK_BASE_DATE${status.count-1 }' readonly='readonly' value="${item.STOCK_BASE_DATE }"></td>
									<td class='ui-widget-content jqgrow ui-row-ltr' colspan='4' align='right'><input type='checkbox' name='STOCK_DEL' value='${status.count-1 }'></td>
								</tr>
								<tr>
									<td class='ui-widget-content jqgrow ui-row-ltr'>公司名称</td><td class='ui-widget-content jqgrow ui-row-ltr'><input id='STOCK_COMPANY${status.count-1 }' name='STOCK_COMPANY' value="${item.STOCK_COMPANY }"></td>
									<td class='ui-widget-content jqgrow ui-row-ltr'>联络电话</td><td class='ui-widget-content jqgrow ui-row-ltr'><input id='STOCK_PHONE${status.count-1 }' name='STOCK_PHONE' value="${item.STOCK_PHONE }"></td>
									<td class='ui-widget-content jqgrow ui-row-ltr'>联络人</td><td class='ui-widget-content jqgrow ui-row-ltr'><input id='STOCK_LINK_MAN${status.count-1 }' name='STOCK_LINK_MAN' value="${item.STOCK_LINK_MAN }"></td>
								</tr>
								<tr>
									<td class='ui-widget-content jqgrow ui-row-ltr'>照会日期</td><td class='ui-widget-content jqgrow ui-row-ltr'><input id='STOCK_MEET_DATE${status.count-1 }' name='STOCK_MEET_DATE' readonly='readonly' value="${item.STOCK_MEET_DATE }"></td>
									<td class='ui-widget-content jqgrow ui-row-ltr'>往来产品</td><td class='ui-widget-content jqgrow ui-row-ltr'><input id='STOCK_PRODUCTION${status.count-1 }' name='STOCK_PRODUCTION' value="${item.STOCK_PRODUCTION }"></td>
									<td class='ui-widget-content jqgrow ui-row-ltr'>往来期间</td><td class='ui-widget-content jqgrow ui-row-ltr'><input id='STOCK_PERIOD${status.count-1 }' name='STOCK_PERIOD' value="${item.STOCK_PERIOD }"></td>
								</tr>
								<tr>
									<td class='ui-widget-content jqgrow ui-row-ltr'>往来金额</td><td class='ui-widget-content jqgrow ui-row-ltr'><input id='STOCK_MONEY${status.count-1 }' name='STOCK_MONEY' value="<fmt:formatNumber value='${item.STOCK_MONEY }' pattern='#,#00.00' />"></td>
									<td class='ui-widget-content jqgrow ui-row-ltr'>往来条件</td><td class='ui-widget-content jqgrow ui-row-ltr' colspan='3'><input id='STOCK_CONDITION${status.count-1 }' name='STOCK_CONDITION' value="${item.STOCK_CONDITION }"></td>
								</tr>
								<tr>
									<td class='ui-widget-content jqgrow ui-row-ltr' colspan='6'>照会内容</td>
								</tr>
								<tr>
									<td class='ui-widget-content jqgrow ui-row-ltr' colspan='6'><textarea rows='3' cols='180' id='STOCK_CONTENT${status.count-1 }' name='STOCK_CONTENT'>${item.STOCK_CONTENT }</textarea></td>
								</tr>
							</table>
						</c:forEach> --%>
					</td>
							...
							<tr>
								...
								<table cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" id="priorProjectBuyFactory">
										<tr >
											...
											<td  class="ui-state-default ui-th-ltr zc_grid_head" style="font-size: 14px;" colspan="3">
												<img src="${ctx }/images/u103.gif">
												&nbsp;
										...
										<tr>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;"><input type="text" size="35" name="BUYFACTORYNAME" id="BUYFACTORYNAME${ status.count }" value="${item.FACTORYNAME }" style="text-align: center" size="10"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;"><input type="text" size="30" name="BUYTHINGKIND" id="BUYTHINGKIND${ status.count }" value="${item.THINGKIND }" style="text-align: center" size="10"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;"><input type="text" size="15" onchange="buyFactorysPerAndSum('${ status.count }')" name="BUYMONTHINGOPRICE" id="BUYMONTHINGOPRICE${ status.count }" value="<fmt:formatNumber value="${item.MONTHINGOPRICE }" pattern="#,#00.00" />" style="text-align: center" size="10"></td>
											<c:set var="BUYFACTORYOR_ALL" value="${ item.MONTHINGOPRICE +BUYFACTORYOR_ALL }"></c:set>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;"><input type="text" size="15" name="BUYPERCENTGRAVE" id="BUYPERCENTGRAVE${ status.count }" value="<fmt:formatNumber value="${item.PERCENTGRAVE }" pattern="#,#00.00" />" style="text-align: center" size="10"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;"><input type="text" size="35" name="BUYPAYCONDITIONS" id="BUYPAYCONDITIONS${ status.count }" value="${item.PAYCONDITIONS }" style="text-align: center" size="10"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;"><input type="text" name="BUY_LINK_MAN" id="BUY_LINK_MAN${ status.count }" value="${item.BUY_LINK_MAN }" style="text-align: center" size="20"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;"><input type="text" name="BUY_LINK_MAN_PHONE" id="BUY_LINK_MAN_PHONE${ status.count }" value="${item.BUY_LINK_MAN_PHONE }" style="text-align: center" size="20"></td>
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;"><input type="checkbox" name="BUYFACTORYORDER" id="BUYFACTORYORDER${ status.count }" value="${ status.count }"></td>
										</tr>
										</c:forEach>
										...
										<tr>
											...
											<td class="ui-state-default ui-th-ltr zc_grid_head"  align="center" style="font-size: 14px;"><input type="text" size="35" name="BUYFACTORYOR_ALL" id="BUYFACTORYOR_ALL" value="<fmt:formatNumber value='${BUYFACTORYOR_ALL}' pattern='#,#00.00' />" size="8"></td>
										</tr>
							...
							<tr>
								...
								<table cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" id="priorProjectBankCheckBill">
										<tr >
											...
											<td colspan="4" class="ui-state-default ui-th-ltr zc_grid_head" align="right" style="font-size: 14px;">
												相关操作：
												<input type="button" value="从excel导入" class="ui-state-default ui-corner-all" onclick="gotoUploadPage()" style="cursor: pointer;">
												<img src="${ctx }/images/u100.gif">
												&nbsp;
											...
											<td align="center" class="ui-state-default ui-th-ltr zc_grid_head" style="font-size: 14px;">
										...
										<tr >
											...
											<td colspan="3" class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
													<input type="text" size="40" id="BANKBRANCH${ status.count }" name="BANKBRANCH" value="${item.BANKBRANCH }"/>
											</td>
											<td rowspan="2" class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
									...
									<tr >
										...
										<td colspan="7" class="ui-state-default ui-th-ltr zc_grid_head" align="center" style="font-size: 14px;">
				...
				<tr>
					<td class="ui-state-default ui-th-ltr zc_grid_head" style="font-size: 14px;">
							银行同业往来:<br>
							<textarea rows="5" cols="200" id="BANK_TONGYE" name="BANK_TONGYE">${creditPriorFactoryBuld.BANK_TONGYE }</textarea>
					</td>
				</tr>
				<tr>
					<td>
							...
							<tr>
								<td colspan="6"  width="100%">
									<table cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" >
										<tr >
											<td class="ui-state-default ui-th-ltr zc_grid_head" align="left" width="75.5%">
												<strong style="font-size: 14px;">过往项目</strong>
											</td>
				...
				<tr>
					<td>
						<table width="100%" cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" id="thisProjectsTab">
							<tr>
								<td class="ui-state-default ui-th-ltr zc_grid_head" style="font-size: 14px;">
									<b>本次租赁意见总结</b>
								</td>
							 ...
							 <c:if test="${empty creditPriorProject}">移动到租赁方案中  add by ShenQi 2012-8-16
								<tr>
										<td width="19%" class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
											项目名称：
										</td>
							...
							<!--<c:if test="${creditMap.CUST_TYPE eq 1999}">  <tr>    
								...
								<th colspan="5"  class="ui-state-default ui-th-ltr zc_grid_head" style="font-size: 14px;">
									财务情况说明 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;单位（千元）
								</th>
							</tr> 
							<tr>
					...
					<td>
						<table width="100%"cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" id="otherProjectsTab">
							<tr>
								...
								<td width="75.5%"  class="ui-state-default ui-th-ltr zc_grid_head" style="font-size: 14px;">
				...
				<tr>
					<td>
						<table width="100%" id="pingshenyijianTab" cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title">
							<tr>
								<td class="ui-state-default ui-th-ltr zc_grid_head" style="font-size: 14px;">
									<b>说明</b>
								</td>
				...
				<table cellspacing="0" cellpadding="5" border="0"  class="ui-jqgrid-htable zc_grid_title" id="#table1">
					<tr class="ui-widget-content jqgrow ui-row-ltr">
						<td style="background-color: #e8e8e8;" width="70"><strong style="font-size: 14px;">序号</strong></td>
						<td style="background-color: #e8e8e8;" width="608"><strong style="font-size: 14px;">审核意见</strong></td>
						<td style="background-color: #e8e8e8;" width="120"><strong style="font-size: 14px;">审核人</strong></td>
						<td style="background-color: #e8e8e8;" width="50"><strong style="font-size: 14px;">时间</strong></td>
					</tr>
							
					<c:forEach items="${memoList}" var="item" varStatus="status" >														
						<tr class="ui-widget-content jqgrow ui-row-ltr">
							<td style="width: 50px;"><strong style="font-size: 14px;">${status.count}</strong></td>
							<td width="59" align="center" style="font-size: 14px;"><pre style="font-size: 14px;">${item.MEMO}</pre></td>
		...
		<div id="updateDiv" style="display:none;" title="上传附件">
			<div class="zc_grid ui-jqgrid ui-widget ui-widget-content ui-corner-all" id="main">
		          <div class="zc_grid_body jqgrowleft">
					<div class="ui-widget-content jqgrow ui-row-ltr ">
						<form action="../servlet/defaultDispatcher?__action=creditPriorRecords.uploadExcel&credit_id=${creditMap.ID }" method="post" enctype="multipart/form-data">
				...
				<div class="ui-state-default ui-corner-all">
					Excel格式说明：<br>
					期间(月)栏位填写日期,如:2012-1-1,2012-2-1<br>
					上期结余,每月收入,每月支出栏位填写数字,如1000<br>
					户名,银行支行栏位填写文字,如XXX公司,XXX银行<br>
					账户栏位填写数字,如123456789
				</div>
				<div>
					<a href="${pageContext.request.contextPath}/downloads/bankTemplate.xls">下载Excel模板</a>
				</div>
			</div>
		</div>
	</body>
