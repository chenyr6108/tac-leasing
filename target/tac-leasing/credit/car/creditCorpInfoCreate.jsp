...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/credit/car/js/creditCustomerCorp.js"></script>
		<script type="text/javascript">
			...
			function saveNatural() {
				var dataObject={__action:"creditVoucher.saveNatural",
			...
			function checkValue(e){
				var code = $("#ORGANIZATION_CODE_CERTIFICATE").val().replace(/-/g, "");
	...
	<body>
		<form action="../servlet/defaultDispatcher" name="corpForm" id="corpForm"
			...
			<c:if test="${creditMap.CUST_TYPE eq 1}"><input type="hidden" name="__action"
				value="creditCustomerCorp.createOrUpdateCreditCustomerCorp"></c:if>
			<c:if test="${creditMap.CUST_TYPE eq 0 }"><input type="hidden" name="__action"
				value="creditCustomerCorp.createOrUpdateCreditCustomerNatu"></c:if>
			...
			<table cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title">
				<tr>
					<td width="100%" class="ui-state-default ui-th-ltr zc_grid_head">
						<strong style="font-size: 14px;">基本承租人信息</strong>
					</td>
				</tr>
				<tr>
					<td width="100%">
					<c:if test="${creditMap.CUST_TYPE eq 1 }"><table width="100%" cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title">
							<tr>
								<td width="3%" rowspan="13" class="ui-state-default ui-th-ltr zc_grid_head" style="font-size: 14px;">
									法
									<br />
									人
									<br />
							...
							<tr>
								...
								<td colspan="2"  class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
									...
									千元,货币：<select name="REGISTERED_CAPITAL_CURRENCY">
								...
								<td colspan="3"  class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
									...
									千元,货币：<select name="CONTRIBUTED_CAPITAL_CURRENCY">
										<c:forEach var="currency" items="${currencys }">
							...
							<tr>
								...
								<td colspan="6"  class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
									<textarea rows="3" cols="100" name="BUSINESS_SURVEY" class="txtk">${creditCustomerCorpMap.BUSINESS_SURVEY }</textarea>
								</td>
							</tr>
							<tr>
								<td class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
		...
		<tr><td colspan="6"><input type="button" value="保存到担保人信息(自然人)" class="ui-state-default ui-corner-all" style="cursor: pointer;" onclick="saveNatural()"></td></tr>
							<tr>
								...
								<td colspan="3"  class="ui-widget-content jqgrow ui-row-ltr"   <c:if test="${creditCustomerCorpMap.LEGAL_IDCARD_FLAG ne 0}"> style="display:none"  </c:if>     >
									  <input type="hidden" style="width: 200px;font-size:14px;" name="LEGAL_ID_CARD" id="LEGAL_ID_CARD1" value="${creditCustomerCorpMap.LEGAL_ID_CARD }" >  
								</td>
								<td colspan="3"  class="ui-widget-content jqgrow ui-row-ltr"  <c:if test="${creditCustomerCorpMap.LEGAL_IDCARD_FLAG eq 0}">style="display:none" </c:if>   >
									  <input type="text" style="width: 200px;font-size:14px;" name="LEGAL_ID_CARD" id="LEGAL_ID_CARD2"  value="${creditCustomerCorpMap.LEGAL_ID_CARD }" >  
								</td>
							</tr>
							<tr>
								<td  class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
							...
							<tr>
								...
								<td colspan="3"  class="ui-widget-content jqgrow ui-row-ltr"   <c:if test="${not empty trueContact.CARD_FLAG and trueContact.CARD_FLAG != 0}"> style="display:none"  </c:if>     >
									  <input type="hidden" style="width: 200px;font-size:14px;" name="CARD_ID" id="CARD_ID1" value="${trueContact.CARD_ID }" />  
								</td>
								<td colspan="3"  class="ui-widget-content jqgrow ui-row-ltr"  <c:if test="${empty trueContact.CARD_FLAG or trueContact.CARD_FLAG eq 0}">style="display:none" </c:if>   >
									  <input type="text" style="width: 200px;font-size:14px;" name="CARD_ID" id="CARD_ID2"  value="${trueContact.CARD_ID }" />  
								</td>
...
<%--2011/12/21 Yang Yun Update the linkman info to automatic and readonly. Start--%>
								...
								<td colspan="2"  class="ui-widget-content jqgrow ui-row-ltr">
									<span id="LINK_MAN" style="font-size: 14px;">${linkMan.LINK_NAME }</span>
								...
								<td colspan="3"  class="ui-widget-content jqgrow ui-row-ltr">
									<span id="LINK_ID_CARD2" style="font-size: 14px;">${linkMan.LINK_IDCARD }</span>
							...
							<tr>
								...
								<td colspan="2"  class="ui-widget-content jqgrow ui-row-ltr">
									<span id="LINK_TELEPHONE" style="font-size: 14px;">${linkMan.LINK_PHONE }</span>
								...
								<td width="15%"  class="ui-widget-content jqgrow ui-row-ltr">
									<span id="LINK_JOB" style="font-size: 14px;">${linkMan.LINK_DUTY }</span>
								...
								<td width="21%"  class="ui-widget-content jqgrow ui-row-ltr">
									<span id="LINK_POSTCODE" style="font-size: 14px;">${linkMan.LINK_ZIP }</span>
							...
							<tr>
								...
								<td colspan="6"  class="ui-widget-content jqgrow ui-row-ltr">
									<span id="LINK_MAILING_ADDRESS" style="font-size: 14px;">${linkMan.LINK_WORK_ADDRESS }</span>
							...
							<tr>
								...
								<td colspan="2"  class="ui-widget-content jqgrow ui-row-ltr">
									<span id="LINK_MOBILE_NUMBER1" style="font-size: 14px;">${linkMan.LINK_MOBILE }</span>
								...
								<td colspan="3"  class="ui-widget-content jqgrow ui-row-ltr">
									<span id="LINK_MOBILE_NUMBER2" style="font-size: 14px;">${creditCustomerCorpMap.LINK_MOBILE_NUMBER2 }</span>
							...
							<tr>
								...
								<td colspan="2"  class="ui-widget-content jqgrow ui-row-ltr">
									<span id="LINK_EMAIL" style="font-size: 14px;">${linkMan.LINK_EMAIL }</span>
								...
								<td colspan="2"  class="ui-widget-content jqgrow ui-row-ltr">
									<span id="LINK_MSN" style="font-size: 14px;">${creditCustomerCorpMap.LINK_MSN }</span>
...
<%--2011/12/21 Yang Yun Update the linkman info to automatic and readonly. end--%>
					 ...
					 <table width="100%" cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title">  
					 	...
					 	<tr>	
					 		<td  class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
								...
								value="${creditCustomerCorpMap.NATU_IDCARD}"  style="font-size: 14px;"></td>
								...
								value="${creditCustomerCorpMap.NATU_IDCARD}" style="width: 200px;font-size:14px;" ></td>
								<td  class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
									年龄：
								</td>
								<td    class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
								...
								--><input type="text" name="age" id="nat_idcardAges"
									style="width: 100px;font-size:14px;" class="txtk" value="${creditCustomerCorpMap.NATU_AGE }${creditCustomerCorpMap.AGE } ">
						...
						<table width="100%" id="bankTab"cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title">
							<tr>
								<td colspan="5" class="ui-state-default ui-th-ltr zc_grid_head">
									<strong style="font-size: 14px;">开户银行</strong>
								</td>
								...
								<td width="9%" class="ui-state-default ui-th-ltr zc_grid_head" style="font-size: 14px;">
							...
							<c:if test="${fn:length(corpBankAccount) >1}">
								<tr>
									<td   rowspan="${fn:length(corpBankAccount)}" id="bankTd" style="text-align: center;font-size:14px;" class="ui-widget-content jqgrow ui-row-ltr">
										其他账户
									</td>
								</tr>
							</c:if>
				...
				<tr>
					<td width="100%">
						<c:if test="${creditMap.CUST_TYPE eq 1 }"><br><br><br><table width="100%" cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" id="shareholderTab">
							<tr>
								<td colspan="5" class="ui-state-default ui-th-ltr zc_grid_head">
									<strong style="font-size: 14px;">公司股东及份额</strong>
								</td>
								<td width="16%"  class="ui-state-default ui-th-ltr zc_grid_head" style="font-size: 14px;">
									相关操作：
									<img src="${ctx }/images/u100.gif">
									&nbsp;
							...
							<c:forEach items="${corpSharholder}" var="item">
								<tr class="ui-widget-content jqgrow ui-row-ltr"> 
									<td   style="text-align: center;font-size:14px;" class="ui-widget-content jqgrow ui-row-ltr"><input type="checkbox" name="scheck_id" id="scheck_id0"></td>
									<td  style="text-align: center;font-size:14px;"  class="ui-widget-content jqgrow ui-row-ltr"><input type="text" name="HOLDER_NAME" id="HOLDER_NAME"
											style="width: 180px;" value="${item.HOLDER_NAME }"></td>
									<td  style="text-align: center;font-size:14px;" class="ui-widget-content jqgrow ui-row-ltr"><input type="text" name="HOLDER_CAPITAL" id="HOLDER_CAPITAL" onchange="getTotal()" 
											style="width: 120px" value="${item.HOLDER_CAPITAL }"></td>
									<td   style="text-align: center;font-size:14px;" class="ui-widget-content jqgrow ui-row-ltr"><input type="text" name="HOLDER_WAY" id="HOLDER_WAY"
											style="width: 140px;" value="${item.HOLDER_WAY }"></td>
									<td  style="text-align: center;font-size:14px;"  class="ui-widget-content jqgrow ui-row-ltr"><input type="text" name="HOLDER_RATE" id="HOLDER_RATE"
											style="width: 40px;" value="${item.HOLDER_RATE }">%</td>
									<td  style="text-align: center;font-size:14px;" colspan="2"  class="ui-widget-content jqgrow ui-row-ltr"><input type="text" name="HOLDER_MOME" id="HOLDER_MOME"
							...
							<tr>
								<td colspan="5" class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
									合计：<span id="sharHolderTotal" style="font-size: 14px;"><fmt:formatNumber value="${total}" type="currency" /></span>
								</td>
								<td colspan="2"  class="ui-widget-content jqgrow ui-row-ltr">
									&nbsp;
								</td>
						...
						<c:if test="${creditMap.CUST_TYPE eq 0 }"><br><br><br><table width="100%" cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" id="shareholderTab2">
							<tr>
								...
								<td width="8%"  class="ui-state-default ui-th-ltr zc_grid_head" style="font-size: 14px;">
									<img src="${ctx }/images/u103.gif">
									&nbsp;
							...
							<tr>
								<td width="8%"  class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
									亲属姓名
								</td>
								<td width="10%"  class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
									与承租人关系
								...
								<td width="16%"  class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
									备注
								</td>
								<td width="8%"  class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
									操作
							...
							<c:forEach items="${natufam}" var="item">
								<tr class="ui-widget-content jqgrow ui-row-ltr"> 
									<td     class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;"><input type="text" name="fam_name"  size="10"
											  value="${item.FAM_NAME }"></td>
									<td    class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;"><input type="text" name="fam_relation"  size="10"
											  value="${item.FAM_RELATION }"></td>
									<td     class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;"><input type="text" name="fam_link"   size="15"
											  value="${item.FAM_LINK }"></td>
									<td    class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;"><input type="text" name="fam_addr"   size="60"
											  value="${item.FAM_ADDR }"></td>
									<td     class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;"><input type="text" name="remark"   size="17"
											  value="${item.REMARK }"></td>
									<td    class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;"><img name="devill" onclick="deleteShareholder3();" src="../images/u103.gif"> </td>
				...
				<tr>
					<td width="100%">
						<c:if test="${creditMap.CUST_TYPE eq 1 }"><br><br><br><table width="100%" cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" id="projectTab">
							<tr>
							...
							<c:forEach items="${corpProject}" var="item" varStatus="status">
								...
								<tr>
									<td width="19%" height="50" style="text-align: center;font-size:14px;" class="ui-widget-content jqgrow ui-row-ltr">
										&nbsp;&nbsp;&nbsp; 内&nbsp; &nbsp;容：
						...
						<c:if test="${creditMap.CUST_TYPE eq 0 }"><br><br><br><table width="100%" cellspacing="0" cellpadding="5" border="0" class="ui-jqgrid-htable zc_grid_title" id="shareholderTab3">
							<tr>
								<td colspan="4" class="ui-state-default ui-th-ltr zc_grid_head">
							...
							<tr>
								<td width="9%"  class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
									 姓名
								</td>
								<td width="30%"  class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
									工作单位
								</td>
								<td width="12%" class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;">
									职务
							...
							<c:forEach items="${natusoc}" var="item">
								<tr class="ui-widget-content jqgrow ui-row-ltr"> 
									<td     class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;"><input type="text" name="soci_name"  size="10"
											  value="${item.SOCI_NAME }"></td>
									<td     class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;"><input type="text" name="soci_work"  size="42"
											  value="${item.SOCI_WORK }"></td>
									<td     class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;"><input type="text" name="soci_position"  size="12"
											  value="${item.SOCI_POSITION }"></td>
									<td   class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;"><input type="text" name="soci_link" 
											  value="${item.SOCI_LINK }"></td>
									<td  class="ui-widget-content jqgrow ui-row-ltr" style="font-size: 14px;"><input type="text" name="soci_remark" 
