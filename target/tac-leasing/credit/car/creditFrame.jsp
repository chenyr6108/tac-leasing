...
<html>
  ...
  <script type="text/javascript" src="${ctx }/credit/car/js/creditVoucherAndDebt.js"></script>
	</head>
	<body>
	<table align="center" style="width: 100% !important; overflow: auto; table-layout:fixed;">
		...
		<div id="tabs">
			<ul>
				<li>
					<a href="#tabs-1" onclick="javascript:location.href='${ctx }/servlet/defaultDispatcher?__action=creditReport.selectCreditForUpdate&credit_id=${creditMap.ID }&showFlag=0&functionFrom=${SUPPORT }'">租赁方案</a>
				</li>
				<li>
				...
				<li>
					<a href="#tabs-5" onclick="javascript:location.href='${ctx }/servlet/defaultDispatcher?__action=creditPaylistService.createCreditPaylist&credit_id=${creditMap.ID }&showFlag=4&word=up&functionFrom=${SUPPORT }'">租金测算</a>
				</li>
				<li>
