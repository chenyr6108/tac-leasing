...
<table width="982" cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
	<tr>
		...
		<td  class="ui-state-default ui-th-ltr zc_grid_head" style="font-size: 14px;display: none;">
	...
	<c:forEach items="${paylist.paylines }" var="item"  varStatus="status">
	 ...
	 <tr>
		...
		<td   style="text-align: right;font-size:14px;" class="ui-widget-content jqgrow ui-row-ltr">
			...
			<input type="hidden" value="${TOTAL_REN_PRICE }" id="totalRenPrice">
		</td>
		<td style="text-align: right;font-size:14px;" class="ui-widget-content jqgrow ui-row-ltr">
		</td>
		<c:if test="${paylist.TAX_PLAN_CODE eq '4' or paylist.TAX_PLAN_CODE eq '6' or paylist.TAX_PLAN_CODE eq '7' or paylist.TAX_PLAN_CODE eq '8'}">
			...
			<td style="text-align: right;font-size:14px;" class="ui-widget-content jqgrow ui-row-ltr">
				...
				<input id="totalPayAddTax" type="hidden" value='<fmt:formatNumber value="${TOTAL_PAY_TAX_ADD_PRICE }" type="currency" />'>
				<input id="totalPayAddTax1" type="hidden" value='${TOTAL_PAY_TAX_ADD_PRICE }'>
			</td>
			<td style="text-align: right;font-size:14px;" class="ui-widget-content jqgrow ui-row-ltr">
				&nbsp;
			</td>
...
<c:if test="${paylist.TAX_PLAN_CODE eq '4' or paylist.TAX_PLAN_CODE eq '6' or paylist.TAX_PLAN_CODE eq '7' or paylist.TAX_PLAN_CODE eq '8'}">
	...
	<input type="hidden" id="total_price_Q" value="${TOTAL_IRR_MONTH_PRICE }">
	<input type="hidden" id="total_ren_price_Q" value="${TOTAL_REN_PRICE }">
</c:if>
<c:if test="${paylist.TAX_PLAN_CODE ne '4' and paylist.TAX_PLAN_CODE ne '6' and paylist.TAX_PLAN_CODE ne '7' and paylist.TAX_PLAN_CODE ne '8'}">
