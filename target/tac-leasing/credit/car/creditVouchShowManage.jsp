...
<html>
	...
	<body>
		<form action="../servlet/defaultDispatcher" name="form1" id="form1" method="post">
			<input type="hidden" name="__action" id="__action" value="creditVouchManage.getAllCieditVouchManage">
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px">
		   		<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;" >&nbsp;&nbsp;担保人授信管理</span>
		   	</div>
			...
			<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
				...
				<c:forEach items="${dw.rs}" var="item">
					<tr class="ui-widget-content jqgrow ui-row-ltr">   
						...
						<td style="text-align: center;"><a href="javaScript:void(0)" onclick="javaScript:location.href='${ctx }/servlet/defaultDispatcher?__action=creditVouchManage.queryLog&VOUCH_NAME=${item.NAME }&VOUCH_CODE=${item.CODE }&TYPE=${item.TYPE }'">查看</a> <a href="javaScript:void(0)" onclick="javaScript:location.href='${ctx }/servlet/defaultDispatcher?__action=creditVouchManage.getProductCreditJsp&VOUCH_NAME=${item.NAME }&VOUCH_CODE=${item.CODE }&TYPE=${item.TYPE }'">添加授信</a> <a href="javaScript:void(0)" onclick="javaScript:location.href='${ctx }/servlet/defaultDispatcher?__action=creditVouchManage.delProductCreditPlan&VOUCH_NAME=${item.NAME }&VOUCH_CODE=${item.CODE }&TYPE=${item.TYPE }'">取消授信</a></td>
					</tr>
				</c:forEach>
			</table>
