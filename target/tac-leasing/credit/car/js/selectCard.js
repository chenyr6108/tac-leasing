...
function selectCard(n){
	...
	if(n==0){
			$("#creditfile").load("../servlet/defaultDispatcher?__action=creditReport.queryRentFile&prcd_id="+prcd_id+"&cardFlag=0&isSalesDesk="+$("#isSalesDesk").val());
	}
	if(n==1){
			$("#creditfile").load("../servlet/defaultDispatcher?__action=creditReport.queryRentFile&prcd_id="+prcd_id+"&cardFlag=1&isSalesDesk="+$("#isSalesDesk").val());		 
	}	
	if(n==2){
			$("#creditfile").load("../servlet/defaultDispatcher?__action=creditReport.queryRentFile&prcd_id="+prcd_id+"&cardFlag=2"); 
	}	 
}
