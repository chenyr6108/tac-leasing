...
function sumZiChanZongE(){ 
	for(i=1;i<=3;i++){
		  ...
		  $("#capital_sum"+i).val(Math.round(value3 * 100) / 100.00);   
	}
}
...
function initAllData(){ 
	$("#capitalAndDebtTab tr").each(function(n){
		if(n>=2){
			parents=(Math.round($(this).find("td").eq(1).find("input").val()*10000/$("#capital_sum1").val()))/100.0;
			$(this).find("td").eq(2).html(parents+"%");
			parents=(Math.round($(this).find("td").eq(4).find("input").val()*10000/$("#capital_sum2").val()))/100.0;
			$(this).find("td").eq(5).html(parents+"%");
			parents=(Math.round($(this).find("td").eq(7).find("input").val()*10000/$("#capital_sum3").val()))/100.0;
...
function initTable2Data(){
	$("#capitalAndDebtTab2 tr").each(function(n){
		if(n==3){
			date1=DateDiff($("#s_start_date1").val(),$("#project_item1").val())+1;
			date2=DateDiff($("#s_start_date2").val(),$("#project_item2").val())+1; 
			if(parseFloat($(this).find("td").eq(4).find("input").val())==0){
				value1="NaN";
			}else{ 
				value1=Math.round(($(this).find("td").eq(1).find("input").val()*365/date1-$(this).find("td").eq(4).find("input").val())
...
//				/$(this).find("td").eq(7).find("input").val()*10000)/100.0;
				value1 = Math.round(($(this).find("td").eq(4).find("input").val() -	$(this).find("td").eq(7).find("input").val()) 
						/$(this).find("td").eq(7).find("input").val()*10000)/100.0;
			}
