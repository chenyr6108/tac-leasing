							...
							<tbody>
								<c:forEach items="${dw.rs}" var="item" varStatus="status">													
									<tr class="ui-widget-content jqgrow ui-row-ltr">
										...
										<td style="text-align: center;"><a href="javascript:void(0)" onclick="javascript:location.href='${ctx }/servlet/defaultDispatcher?__action=rentContractEquiMDF.initThingNumberRentUpdate&RECT_ID=${item.RECT_ID }&PRCD_ID=${item.PRCD_ID }'">修改</a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
