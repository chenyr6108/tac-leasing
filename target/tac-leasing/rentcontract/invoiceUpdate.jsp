           ...
           <div class="ui-state-default ui-jqgrid-hdiv ">
					<table width="99%" border="0" cellspacing="1" cellpadding="0" class="STYLE2" bgcolor="#798d98">
					    <tr>
					        ...
					        <td colspan="2" width="15%"><INPUT TYPE="text" NAME="INVOICE_DATE" id="INVOICE_DATE" readonly="readonly" value="<fmt:formatDate value="${invoice.INVOICE_DATE}" pattern="yyyy-MM-dd"/>"></td>
							...
							<c:forEach items="${macInfor}" var="item" varStatus="status">									     
								    ...
								    <table width="99%" border="0" cellspacing="1" cellpadding="0" class="STYLE2" bgcolor="#798d98">										    									    
									    <tr>
									        ...
									        <td width="15%">名称</td>
									        <td width="30%"><INPUT TYPE="text" NAME="PARTY_A_NAME" id="PARTY_A_NAME" style="border-top-style:none;   border-left-style:none;   border-right-style:none;border-bottom-style:none"  value="${invoice.PARTY_A_NAME }" readonly="readonly"></td>
									        <td width="15%">地址</td>
									        <td><INPUT TYPE="text" NAME="PARTY_A_ADDR" id="PARTY_A_ADDR"  value="${invoice.PARTY_A_ADDR }"></td>
									     </tr>
									     <tr>
									        <td>委托代理人</td>
									        <td><INPUT TYPE="text" NAME="PARTY_A_ATTORNEY" id="PARTY_A_ATTORNEY"  value="${invoice.PARTY_A_ATTORNEY}"></td>
									        <td>日期</td>    
									        <td><INPUT TYPE="text" NAME="PARTY_A_SIGNTIME" id="PARTY_A_SIGNTIME" readonly="readonly" value="<fmt:formatDate value="${invoice.PARTY_A_SIGNTIME }" pattern="yyyy-MM-dd"/>"></td>									        										        	
									     </tr>
									    <tr>
									        <td rowspan="5" align="center">乙<br>方</td>
									        <td>名称</td>
									        <td><INPUT TYPE="text" NAME="PARTY_B_NAME" id="PARTY_B_NAME" style="border-top-style:none;   border-left-style:none;   border-right-style:none;border-bottom-style:none"  value="${invoice.PARTY_B_NAME}" readonly="readonly"></td>
									        <td>电话</td>
									        <td><INPUT TYPE="text" NAME="PARTY_B_PHONE" id="PARTY_B_PHONE"  value="${invoice.PARTY_B_PHONE }"></td>
									     </tr>
									    <tr>
									        <td>地址</td>
									        <td colspan="3"><INPUT TYPE="text" NAME="PARTY_B_ADDR" id="PARTY_B_ADDR"  value="${invoice.PARTY_B_ADDR }"></td>
									     </tr>
									    <tr>
									        <td>开户银行</td>
									        <td><INPUT TYPE="text" NAME="PARTY_B_BANK" id="PARTY_B_BANK"  value="${invoice.PARTY_B_BANK}"></td>
									        <td>帐号</td>
									        <td><INPUT TYPE="text" NAME="PARTY_B_ACCOUNT" id="PARTY_B_ACCOUNT"  value="${invoice.PARTY_B_ACCOUNT }"></td>
									     </tr>
									    <tr>
									        <td>单位税号</td>
									        <td><INPUT TYPE="text" NAME="PARTY_B_DUTY" id="PARTY_B_DUTY"  value="${invoice.PARTY_B_DUTY}">&nbsp;</td>
									        <td>组织机构代码证号</td>
									        <td><INPUT TYPE="text" NAME="PARTY_B_CODE" id="PARTY_B_CODE"  value="${invoice.PARTY_B_CODE}"></td>
									     </tr>									     									     									     
									     <tr>
									        <td>委托代理人</td>
									        <td><INPUT TYPE="text" NAME="PARTY_B_ATTORNEY" id="PARTY_B_ATTORNEY" value="${invoice.PARTY_B_ATTORNEY}"></td>
									        <td>日期</td>
									        <td><INPUT TYPE="text" NAME="PARTY_B_SIGNTIME" id="PARTY_B_SIGNTIME" readonly="readonly" value="<fmt:formatDate value="${invoice.PARTY_B_SIGNTIME}" pattern="yyyy-MM-dd"/>"></td>									        										        	
									     </tr>
									    <tr>
									        <td rowspan="5" align="center">丙<br>方</td>
									        <td>名称</td>
									        <td><INPUT TYPE="text" NAME="PARTY_C_NAME" id="PARTY_C_NAME"  value="${invoice.PARTY_C_NAME}"></td>
									        <td>电话</td>
									        <td><INPUT TYPE="text" NAME="PARTY_C_PHONE" id="PARTY_C_PHONE" value="${invoice.PARTY_C_PHONE}"></td>
									     </tr>
									    <tr>
									        <td>地址</td>
									        <td colspan="3"><INPUT TYPE="text" NAME="PARTY_C_ADDR" id="PARTY_C_ADDR" value="${invoice.PARTY_C_ADDR}"></td>
									     </tr>
									    <tr>
									        <td>开户银行</td>
									        <td><INPUT TYPE="text" NAME="PARTY_C_BANK" id="PARTY_C_BANK" value="${invoice.PARTY_C_BANK}"></td>
									        <td>帐号</td>
									        <td><INPUT TYPE="text" NAME="PARTY_C_ACCOUNT" id="PARTY_C_ACCOUNT" value="${invoice.PARTY_C_ACCOUNT}"></td>
									     </tr>
									    <tr>
									        <td>单位税号</td>
									        <td><INPUT TYPE="text" NAME="PARTY_C_DUTY" id="PARTY_C_DUTY" value="${invoice.PARTY_C_DUTY}"></td>
									        <td>组织机构代码证号</td>
									        <td><INPUT TYPE="text" NAME="PARTY_C_CODE" id="PARTY_C_CODE"  value="${invoice.PARTY_C_CODE}"></td>
									     </tr>									     									     									     
									     <tr>
									        <td>委托代理人</td>
									        <td><INPUT TYPE="text" NAME="PARTY_C_ATTORNEY" id="PARTY_C_ATTORNEY" value="${invoice.PARTY_C_ATTORNEY}"></td>
									        <td>日期</td>
									        <td><INPUT TYPE="text" NAME="PARTY_C_SIGNTIME" id="PARTY_C_SIGNTIME" readonly="readonly" value="<fmt:formatDate value="${invoice.PARTY_C_SIGNTIME}" pattern="yyyy-MM-dd"/>"></td>									        										        	
									     </tr>									     										     							    
							</table>
						</div>
				</div>
				...
				<div align="center">
					<input type="button" class="ui-state-default ui-corner-all" name="subbut" value="保  存" onClick="updateInvoice();">
