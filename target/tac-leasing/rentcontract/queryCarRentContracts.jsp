...
<html>
	...
	<body>
		<form id="form1" name="form1" method="POST"  action="${ctx}/servlet/defaultDispatcher">
			<input type="hidden" name="__action" id="__action" value="rentContractEquiMDF.queryCarRentContracts" />
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px">
		   		<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;" >&nbsp;&nbsp;补充乘用车资讯</span>
		   	</div>
						...
						<table class="grid_table">
							...
							<tbody>
								<c:forEach items="${dw.rs}" var="item" varStatus="status">													
									...
									<a href="javascript:void(0)" onclick="javascript:location.href='${ctx }/servlet/defaultDispatcher?__action=rentContractEquiMDF.initCarRentUpdate&RECT_ID=${item.RECT_ID }&PRCD_ID=${item.PRCD_ID }&productionType=3'">修改</a>
										</td>
									</tr>
									<tr>
