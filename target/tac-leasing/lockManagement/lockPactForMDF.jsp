...
//ajax修改LockCode信息
function modifyLockCode(e,PRCD_ID,RECT_ID, EQMT_ID,LOCK_CODE){
									...
									<td colspan="4"><table cellspacing="0" cellpadding="0" border="0" width="100%" class="ui-jqgrid-htable zc_grid_title">
											<c:forEach items="${rentEquipmentList}" var="item" varStatus="status">
												<tr class="ui-widget-content jqgrow ui-row-ltr">
													...
													<td width="50" align="center"><input type="button" name="sub" class="ui-state-default ui-corner-all" onclick="modifyLockCode(this,${PRCD_ID},${RECT_ID},${item.EQMT_ID},${item.LOCK_CODE});"  value="修改"/></td>
												</tr>
											</c:forEach>
										</table></td>
								</tr></table></td>
