...
$(function(){
	...
	<body>
		<form id="form1" name="form1" method="POST" action="${ctx}/servlet/defaultDispatcher?__action=customer.getExportCustVirtualCodeLog">
			<input type="hidden" name="__action" value="customer.getExportCustVirtualCodeLog" />
		...
		<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
			...
			<c:forEach items="${dw.rs}" var="item" varStatus="status">
				<tr class="ui-widget-content jqgrow ui-row-ltr">
					...
					<td style="text-align: center;">${item.EXPORT_TIME }&nbsp;</td>
				</tr>
			</c:forEach>
			</tbody>
		</table>
