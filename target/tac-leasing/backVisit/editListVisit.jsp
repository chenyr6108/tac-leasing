...
<form action="${pageContext.request.contextPath}/servlet/defaultDispatcher?__action=backVisit.updateVisitManagerByVisit_Id" method="post" id="addForm" name="addForm" >
	...
	<c:forEach items="${backVisit }" var="backVisit" varStatus="status">
		...
		<tr id="2" class="ui-widget-content jqgrow ui-row-ltr">
			...
			<td> 预访日期：</td>
			<td colspan="3"><input type="hidden" name="create_id" id="create_id" value="${s_employeeId }"><input type="text" value="" size="10" id="visitOldDate" name="visitOldDate" style="height:25px" readonly="readonly"></td>
