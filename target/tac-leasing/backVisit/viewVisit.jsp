...
<body  onload="changeTr('${backVisit.VISIT_RESULTS }')">
	...
	<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
		...
		<tr id="3" class="ui-widget-content jqgrow ui-row-ltr">
			...
			<td>是否营业： </td>
			<td><input  type="text" style="height:25px" readonly="readonly" value="<c:if test='${backVisit.IS_BUSINESS eq 0 }'>是</c:if><c:if test='${backVisit.IS_BUSINESS eq 1 }'>否</c:if>"></td>
			<td>接触对象： </td>
			...
			<td>是否见标的物： </td>
			<td><input  type="text" style="height:25px" readonly="readonly" value="<c:if test='${backVisit.IS_PRODUCTS eq 0 }'>是</c:if><c:if test='${backVisit.IS_PRODUCTS eq 1 }'>否</c:if>"></td>
		</tr>
		<tr id="3" class="ui-widget-content jqgrow ui-row-ltr">
			<td>标的物外观： </td>
