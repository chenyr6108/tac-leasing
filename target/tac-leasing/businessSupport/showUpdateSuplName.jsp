...
<script type="text/javascript">
	...
	$(function (){
		suplDropDownList($("#related"));
		$("#related").attr("disabled", true);
		$("#updated").attr("disabled", true);
	});
	
	function doUpdateSuplName(){
		$("#__action").val("businessSupport.doUpdateSuplName");
		$('#thisForm').submit();
	}
...
<input type="hidden" name="__action" id="__action" value="businessSupport.showUpdateSuplName"/>
<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px">
	<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;" >&nbsp;&nbsp;修改供应商</span>
</div>
...
<br/>
	...
	<c:if test="${not empty item }">
		...
		<table class="panel_table" align="left" style="width: 70%">
			...
			<tr>
				<th>
					<input type="checkbox" class="cb" onclick="selectCb(this)">修改现有供应商名称：
				</th>
				<td>
					<input type="text" name="supl_name_updated" id="updated" class="panel_text" style="width: 200px;" value="${item.SUPL_NAME }">
				</td>
			</tr>
			<tr>
				<th>
					<input type="checkbox" class="cb" onclick="selectCb(this)">关联新的供应商名称：
				</th>
				<td>
					<input type="text" name="supl_name_related" id="related" class="panel_text" style="width: 200px;">
				</td>
			</tr>
			<tr>
				<th colspan="2">
					<input type="button" value="修  改" onclick="doUpdateSuplName();" class="panel_button" />
				</th>
			</tr>
		</table>
	</c:if>
