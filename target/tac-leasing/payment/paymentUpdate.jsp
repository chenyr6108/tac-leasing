...
<html>
  ...
  <body>
	<form id="form1" name="form1" action="../servlet/defaultDispatcher" method="post" onsubmit="return subPayment()">
  		<input type="hidden" name="__action" value="paymentService.updatePayment">	 
  		...
  		<input type="hidden" name="PUPL_ID" id="PUPL_ID" value="${rateMap.PUPL_ID }">	
  		 <div style="margin:  1%;">
  		<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px ;">
	   		<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;" >&nbsp;&nbsp;付款审批单修改</span>
	   	</div>
		 ...
		 <div class="zc_grid_body jqgrowleft">
  		...
  		<tr><td colspan="9" class="ui-state-default ui-th-ltr zc_grid_head">付款信息</td></tr>
  			<tr>
  				...
  				<c:if test="${paymentLogMap.PAY_MODE eq 1 }"><input type="radio" name="PAY_MODE" id="PAY_MODE" value="1" onclick="radio(this)" checked="checked"/>首款<input type="radio" name="PAY_MODE" id="PAY_MODE"  value="2" onclick="radio(this)"/>尾款<input type="radio" name="PAY_MODE" id="PAY_MODE"  value="3" onclick="radio(this)"/>全款</c:if>
  				<c:if test="${paymentLogMap.PAY_MODE eq 2 }"><input type="radio" name="PAY_MODE" id="PAY_MODE" value="1" onclick="radio(this)" />首款<input type="radio" name="PAY_MODE" id="PAY_MODE"  value="2" onclick="radio(this)" checked="checked"/>尾款<input type="radio" name="PAY_MODE" id="PAY_MODE"  value="3" onclick="radio(this)"/>全款</c:if>
  				<c:if test="${paymentLogMap.PAY_MODE eq 3 }"><input type="radio" name="PAY_MODE" id="PAY_MODE" value="1" onclick="radio(this)"/>首款<input type="radio" name="PAY_MODE" id="PAY_MODE"  value="2" onclick="radio(this)"/>尾款<input type="radio" name="PAY_MODE" id="PAY_MODE"  value="3" onclick="radio(this)"  checked="checked"/>全款</c:if>  
  				</td>
  			</tr>
  			<tr class="ui-widget-content jqgrow ui-row-ltr">
  				<td style="text-align: center;">收款人：</td>
  				<td colspan="3"><input type="text" name="PAYEE" id="PAYEE" value="${paymentLogMap.PAYEE }"/></td>
  			</tr>
  			<tr class="ui-widget-content jqgrow ui-row-ltr">
  				<td style="text-align: center;">全称：</td>
  				<td colspan="3"><input type="text" name="PAYEE_FULLNAME" id="PAYEE_FULLNAME" value="${paymentLogMap.PAYEE_FULLNAME }"/></td>
  			</tr>
  			<tr class="ui-widget-content jqgrow ui-row-ltr">
  				<td style="text-align: center;">开户行：</td>
  				<td><input type="text" name="BANK" id="BANK" value="${paymentLogMap.BANK_NAME }"/></td> 				
  				<td style="text-align: center;" width="10%">申请付款额：</td>
  				<td><input type="text" class="input_right" readonly="readonly" name="APP_PAY_RATE" id="APP_PAY_RATE" value="${paymentLogMap.APP_PAY_RATE }" size="4"/>%<input type="text" class="input_right" readonly="readonly" name="APPLICATION_PAYPRICE" id="APPLICATION_PAYPRICE" value="<fmt:formatNumber value="${paymentLogMap.APPLICATION_PAYPRICE }" type="currency" />" /></td> 				
  			</tr>
  			<tr class="ui-widget-content jqgrow ui-row-ltr">
  				<td style="text-align: center;">账号：</td>
  				<td><input type="text" name="ACCOUNT" id="ACCOUNT" value="${paymentLogMap.BANK_ACCOUNT }"/></td>
  				<td style="text-align: center;">核准付款额：</td>
  				<td><input type="text" class="input_right" readonly="readonly" name="VER_PAY_RATE" id="VER_PAY_RATE" value="${paymentLogMap.VER_PAY_RATE }" size="4"/>%<input type="text" class="input_right" readonly="readonly" name="VERIFY_PAYPRICE" id="VERIFY_PAYPRICE" value="<fmt:formatNumber value="${paymentLogMap.VERIFY_PAYPRICE }" type="currency" />"/></td>
  			</tr>
  		</table> 		
  		<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
  			<tr class="ui-widget-content jqgrow ui-row-ltr">
  				<td width="10%" style="text-align: center;">付款事由：</td>
  				<td><textarea cols="110" name="PAY_REMARK" id="PAY_REMARK" >${paymentLogMap.PAY_REMARK}</textarea></td>
  			</tr>
  			<tr>
  				<td style="text-align: center;" class="ui-widget-content jqgrow ui-row-ltr">付款日期：</td>
  				<td class="ui-widget-content jqgrow ui-row-ltr">		
  					<input type="text" readonly="readonly" id="datebegin" name="PAY_DATE" value="<fmt:formatDate value="${paymentLogMap.PAY_DATE}" pattern="yyyy-MM-dd"/>">
  				</td>
  			</tr> 			
  		</table>
  		<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
  		<tr><td colspan="9" class="ui-state-default ui-th-ltr zc_grid_head">签字信息</td></tr>
			<tr class="ui-widget-content jqgrow ui-row-ltr"> 
  				...
  				<td><input type="text" name="APPROVE_SIGN" id="APPROVE_SIGN" value="${paymentLogMap.APPROVE_SIGN }"/></td> 								
  				<td style="text-align: center;">审核人签字</td>
  				<td><input type="text" name="REVIEWERS_SIGN" id="REVIEWERS_SIGN" value="${paymentLogMap.REVIEWERS_SIGN }"/></td>  				  				
  				<td style="text-align: center;">申请人签字</td>	
  				<td><input type="text" name="APPLICATION_SIGN" id="APPLICATION_SIGN" value="${paymentLogMap.APPLICATION_SIGN }"/></td>		
  			</tr>
  			<tr class="ui-widget-content jqgrow ui-row-ltr" align="center"> 
  				<td style="text-align: center;">批准人签字时间</td>  
  				<td><input type="text" readonly="readonly" id="datebegin2" name="APPROVE_DATE" value="<fmt:formatDate value="${paymentLogMap.APPROVE_DATE}" pattern="yyyy-MM-dd"/>"></td>								
  				<td style="text-align: center;">审核人签字时间</td>  
  				<td><input type="text" readonly="readonly" id="datebegin3" name="REVIEWERS_DATE" value="<fmt:formatDate value="${paymentLogMap.REVIEWERS_DATE}" pattern="yyyy-MM-dd"/>"></td>				  				
  				<td style="text-align: center;">申请人签字时间</td>	
  				<td><input type="text" readonly="readonly" id="datebegin4" name="APPLICATION_DATE" value="<fmt:formatDate value="${paymentLogMap.APPLICATION_DATE}" pattern="yyyy-MM-dd"/>"></td>		
  			</tr>
  		</table>
		<center>
			<input type="submit" class="ui-state-default ui-corner-all" name="sub" value="修改" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
