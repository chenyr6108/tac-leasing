...
(function($) {
	...
	$.widget("ui.weekCalendar", {
	    ...
	    _renderCalendar : function() {
	        ...
	        //--by zxb
	        var calendarDayHtml  = "<table class=\"\">\
	            <tbody>\
	            <tr >\
	        ...
	        calendarDayHtml += "</tbody></table>";
	        //
	                    
	        //render calendar body
	        calendarBodyHtml = "<div class=\"calendar-scrollable-grid\">"
	        
	        calendarBodyHtml +=  calendarDayHtml;
	        ...
	        calendarBodyHtml += "</tr></tbody></table></div></div>";
	    ...
	    _addDroppableToWeekDay : function($weekDay) {
	        ...
	        $weekDay.droppable({
	            ...
	            drop: function(event, ui) {
	                ...
	                var $weekDayColumns = self.element.find(".week-calendar-time-slots  .day-column-inner");
