	...
	<body>
		...
		<form name=" form1" id="form1" action="../servlet/defaultDispatcher" method="post">
			...
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px">
		   		<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;" >&nbsp;&nbsp;资金对账</span>
		   	</div>
				<br>	    
							...
							<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
								...
								<c:forEach items="${dw.rs}" var="item" varStatus="status">
									<tr	class="ui-widget-content jqgrow ui-row-ltr">
									 ...
									 --%>
									<td style="text-align: center;"><a href="../servlet/defaultDispatcher?__action=statement.queryCustomerBillForFinance&CUST_ID=${item.CUST_ID }&cust_name=${item.CUST_NAME }">查看</a>&nbsp;</td>
