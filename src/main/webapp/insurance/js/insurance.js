...
function preCreate(id){
	window.location.href="../servlet/defaultDispatcher?__action=insurance.selectEquipment&credit_id="+id;
}
// 查看(投保清单)
function showCover(id){
  	window.location.href="../servlet/defaultDispatcher?__action=insurance.insuranceShow&PRCE_ID="+id;
}
// 修改(投保清单)
function updateCover(id,producttype){
 	window.location.href="../servlet/defaultDispatcher?__action=insurance.insuranceUpdateJsp&PRCE_ID="+id+"&producttype="+producttype;
}
// 删除(投保清单)
function doItCover(id){
if(confirm('确认删除？')){
 	window.location.href="../servlet/defaultDispatcher?__action=insurance.insuranceDel&PRCE_ID="+id;
 	}
}
// 查看(保单)
...
function showDelvStatus(id,delv_status){
	window.location.href="../servlet/defaultDispatcher?__action=insurance.insuranceToShowStatus&delv_id="+id+"&delv_status="+delv_status;
}
// 展开层
function showInsuranceList(code){
	$("#showInsuranceTable" + code).toggle(function () {
		$(this).load("../servlet/defaultDispatcher?__action=insurance.insuranceByCreditId&credit_id=" + code);
	});
}
