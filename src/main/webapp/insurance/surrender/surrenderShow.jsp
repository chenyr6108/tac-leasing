...
<html>
	...
	<body >
		<form id="addform" name="addform" action="../servlet/defaultDispatcher" method="post">
			<input type="hidden" name="__action" value="surrender.createSurrender">
			<input type="hidden" name="INCU_ID" value="${surrender.INCU_ID }">
			<div style="margin:1%;">
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px">
		   		<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;" >&nbsp;&nbsp;退保信息查看</span>
		   	</div>
			...
			<tr>
				<tr class="ui-widget-content jqgrow ui-row-ltr">
					...
					<td style="text-align: left;height:24px;width:25%;">${surrender.SURRENDER_DATE }&nbsp;</td>
					<th style="text-align: left;height:24px;width:25%;" class="ui-state-default ui-th-ltr zc_grid_head">退保金额(元)：</th>
					<td style="text-align: left;height:24px;width:25%;"><fmt:formatNumber value="${surrender.SURRENDER_PRICE }" type="currency"/></td>
				</tr>
				<tr class="ui-widget-content jqgrow ui-row-ltr">
					<th style="text-align: left;height:24px;width:25%;" class="ui-state-default ui-th-ltr zc_grid_head"  colspan="2">查看保单：</th>
					<td colspan="3"><a href="javascript:void(0)" onclick="showInsuList('${surrender.INCU_ID }');">点击查看</a></td>
					</tr>
				<tr class="ui-widget-content jqgrow ui-row-ltr">
					<th style="text-align: left;height:24px;width:180px;" class="ui-state-default ui-th-ltr zc_grid_head">退保原因：</th>
					<td colspan="5"><textarea rows="3" cols="150" name=SURRENDER_REASON>${surrender.SURRENDER_REASON }</textarea></td>
