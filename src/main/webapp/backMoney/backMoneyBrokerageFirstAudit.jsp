...
<html>
	...
	function updateExamById(backId, num) {
		...
		location.href = '${ctx }/servlet/defaultDispatcher?__action=backMoney.updateExamHandlingChargeById&BACKSTATE=10&backId='
				+ backId
				+ "&Num="
				+ num;
	...
	function updateFinancialById(backId, num) {
		...
		location.href = '${ctx }/servlet/defaultDispatcher?__action=backMoney.updateFinancialHandlingChargeById&BACKSTATE=10&backId='
				+ backId
				+ "&Num="
				+ num;
	}
	...
	<c:set var="financialstatus" value="false"/>
		...
		<form id="form1" name="form1" method="POST"  action="${ctx}/servlet/defaultDispatcher">
			...
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px">
		   		<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;" >&nbsp;&nbsp;乘用车佣金拨款审批</span>
		   	</div>
