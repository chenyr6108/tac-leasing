		...
		<form action="../servlet/defaultDispatcher" name="form1" id="form1" method="post">
			...
			<div
				...
				<span class="ui-jqgrid-title"
					style="line-height: 30px; font-size: 15px;">&nbsp;修改起租日、首期支付日</span>
			</div>
					...
					<table cellspacing="0" cellpadding="0" border="0"
						...
						<c:forEach items="${dw.rs}" var="item" varStatus="status">
							<tr class="ui-widget-content jqgrow ui-row-ltr">
								...
								<td style="text-align: center"><a href="javascript:void(0)" onclick="javascript:location.href='${ctx }/servlet/defaultDispatcher?__action=supportUpdatePayMoney.showPayInslist&RECP_ID=${item.RECP_ID }'">更新支付表保险费用</a></td>
							</tr>
						</c:forEach>
						<tr>
							<td align="right" colspan="11" style="text-align:center;background-color: #C5DBEC; " class="ui-state-default ui-jqgrid-hdiv ">
