...
<body>
	<center>
		<form name="checkPayForm" id="checkPayForm" method="POST"  action="../servlet/defaultDispatcher?__action=rentContract.createRentCheckPayLinesForOther">
			<br>
						...
						<div
							...
							<div class="zc_grid_body jqgrowleft">
								...
								<c:choose>
										...
										<c:otherwise>
											<tr>
												<td style="text-align: center;"class="ui-widget-content jqgrow ui-row-ltr" colspan="7">无支票录入数据！&nbsp;</td>
											</tr>
										</c:otherwise>
									</c:choose>
								</table>
