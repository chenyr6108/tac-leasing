...
<html>
	<head>
		...
		function expToExcel(){
		  $("#__action").val("insuranceReport.managePriceTaxToExcelForValueAdd");
		  $("#form1").submit();
		  $("#__action").val("insuranceReport.managePriceTaxReporForValueAdd");
		}	
		function expCustInfoToExcel(){
			  $("#__action").val("insuranceReport.managePriceTaxCustInfoToExcelForValueAdd");
			  $("#form1").submit();
			  $("#__action").val("insuranceReport.managePriceTaxReporForValueAdd");
	...
	<body>
		<form action="../servlet/defaultDispatcher" name="form1" id="form1"
			...
			<input type="hidden" name="__action" id="__action"
				value="insuranceReport.managePriceTaxReporForValueAdd">
	
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px">
		   		<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;" >&nbsp;&nbsp;管理费收入增值税</span>
		   	</div>
			...
			<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title" id="#table1">
				<tr >
					<td><input type="button" class="ui-state-default ui-corner-all"  value="导出管理费收入增值税(EXCEL)"  onclick="expToExcel();"></td>
