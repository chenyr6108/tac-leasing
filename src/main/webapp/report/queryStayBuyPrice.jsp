...
<html>
	<head>
		...
		function expToExcel(){
		  $("#__action").val("insuranceReport.stayBuyPriceTaxToExcel");
		  $("#form1").submit();
		  $("#__action").val("insuranceReport.stayBuyPriceTaxReport");
		}
		
		function expLinkerInfoToExcel(){
		  $("#__action").val("insuranceReport.stayBuyPriceTaxLinkInfoToExcel");
		  $("#form1").submit();
		  $("#__action").val("insuranceReport.stayBuyPriceTaxReport");
		}		
	...
	<body>
		<form action="../servlet/defaultDispatcher" name="form1" id="form1"
			...
			<input type="hidden" name="__action" id="__action"
				value="insuranceReport.stayBuyPriceTaxReport">
	
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px">
		   		<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;" >&nbsp;&nbsp;留购款营业税</span>
		   	</div>
			...
			<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title" id="#table1">
				<tr >
					<td><input type="button" class="ui-state-default ui-corner-all"  value="导出(EXCEL)"  onclick="expToExcel();" style="cursor:pointer">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" class="ui-state-default ui-corner-all"  value="导出客户联系人信息(EXCEL)"  onclick="expLinkerInfoToExcel();" style="cursor:pointer"></td>
