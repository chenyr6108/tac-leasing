...
<html>
	<head> 
		<title>担保人信息</title>
		<script src="../credit_vip/js/creditVoucher.js" type="text/javascript"></script>
		<script src="${ctx}/credit_vip/js/idCard.js" type="text/javascript"></script>
	...
	<div id="addVoucherCorps" style="display: none;" title="担保人（法人）信息添加">
		<form action="../servlet/defaultDispatcher?__action=creditVoucherVip.addCreditCorp" method="post" id="addForm" enctype="multipart/form-data">
	...
	<div id="addVoucherNatus" style="display: none;" title="担保人（自然人）信息添加">
		<form action="../servlet/defaultDispatcher?__action=creditVoucherVip.addCreditNatu" method="post" id="natuForm">
			<input type="hidden" name="credit_id" value="${prcd_id }">
			<input type="hidden" name="showFlag" value="${showFlag }">
