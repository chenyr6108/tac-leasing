	...
	<script type="text/javascript">	
	   function changeMore(){
					  ...
					  if(chk_value.length==0){
					  	alert("你还没有选择报告");
					  	return false;}	  
	  				document.getElementById('credit_idmore').value=chk_value;
	  		$.ajax({
					type:"post",
	...
	<body>
		...
		<form action="../servlet/defaultDispatcher" name="form1" id="form1"
			...
			<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title" id="#table1">
				<tr >
					<td><input type="button" name="but" onclick="changeMore();" style="padding: 2px 10px;" class="ui-state-default ui-corner-all" value="多条转移"><input type="button" name="but" onclick="changeByLot();" style="padding: 2px 10px;" class="ui-state-default ui-corner-all" value="批量转移"></td>
