								...
								<div class="zc_grid_body jqgrowleft">
									...
									<table align="center" width="98%" border="0" cellspacing="0"
										...
										<tr>
											...
											<td 
												style="background: #EBEBEB; color: black;" class="ui-widget-content jqgrow ui-row-ltr">
												${customerInfoMap.NATU_IDCARD }&nbsp;
											</td>
											<td 
												style="background: #EBEBEB; color: black;" class="ui-widget-content jqgrow ui-row-ltr">
												${customerInfoMap.CREDIT_NATU_IDCARD }&nbsp;
											</td>
											<td style="background: #EBEBEB;" align="right" class="ui-widget-content jqgrow ui-row-ltr">
												<span>
													A对 <input type="radio" name="NATU_IDCARD" checked="checked" value="1" /> 
													B对 <input type="radio" name="NATU_IDCARD" value="2" /> 
												</span> &nbsp;
												<input type="hidden" name="NATU_IDCARD_A" value="${customerInfoMap.NATU_IDCARD }"/>
												<input type="hidden" name="NATU_IDCARD_B" value="${customerInfoMap.CREDIT_NATU_IDCARD }"/>
												C <input name="NATU_IDCARD_C"
													style="width: 80px; height: 18px; font-size: 12" />
											</td>
										</tr>
										<tr>
											...
											<td 
												style="background: #EBEBEB; color: black;" class="ui-widget-content jqgrow ui-row-ltr">
												${customerInfoMap.NATU_MATE_NAME }&nbsp;
											</td>
											<td 
												style="background: #EBEBEB; color: black;" class="ui-widget-content jqgrow ui-row-ltr">
												${customerInfoMap.MATE_NAME }&nbsp;
											</td>
											<td style="background: #EBEBEB;" align="right" class="ui-widget-content jqgrow ui-row-ltr">
												<span>
													A对 <input type="radio" name="NATU_MATE_NAME" checked="checked" value="1" /> 
													B对 <input type="radio" name="NATU_MATE_NAME" value="2" /> 
												</span> &nbsp;
												<input type="hidden" name="NATU_MATE_NAME_A" value="${customerInfoMap.NATU_MATE_NAME }"/>
												<input type="hidden" name="NATU_MATE_NAME_B" value="${customerInfoMap.MATE_NAME }"/>
												C <input name="NATU_MATE_NAME_C"
													style="width: 80px; height: 18px; font-size: 12" />
											</td>
										</tr>
										<tr>
											...
											<td 
												style="background: #EBEBEB; color: black;" class="ui-widget-content jqgrow ui-row-ltr">
												${customerInfoMap.NATU_MATE_IDCARD }&nbsp;
											</td>
											<td 
												style="background: #EBEBEB; color: black;" class="ui-widget-content jqgrow ui-row-ltr">
												${customerInfoMap.MATE_IDCARD }&nbsp;
											</td>
											<td style="background: #EBEBEB;" align="right" class="ui-widget-content jqgrow ui-row-ltr">
												<span>
													A对 <input type="radio" name="NATU_MATE_IDCARD" checked="checked" value="1" /> 
													B对 <input type="radio" name="NATU_MATE_IDCARD" value="2" /> 
												</span> &nbsp;
												<input type="hidden" name="NATU_MATE_IDCARD_A" value="${customerInfoMap.NATU_MATE_IDCARD }"/>
												<input type="hidden" name="NATU_MATE_IDCARD_B" value="${customerInfoMap.MATE_IDCARD}"/>
												C <input name="NATU_MATE_IDCARD_C"
													style="width: 80px; height: 18px; font-size: 12" />
											</td>
										</tr>
										<tr>
											...
											<td style="background: #EBEBEB;" align="right" class="ui-widget-content jqgrow ui-row-ltr">
												...
												<input type="hidden" name="CUST_PHONE_B" value="${customerInfoMap.MOBILE_PHONE}"/>
										...
										<tr>
											...
											<td style="background: #EBEBEB;" align="right" class="ui-widget-content jqgrow ui-row-ltr">
												...
												<input type="hidden" name="CUST_FAX_B" value="${customerInfoMap.NATU_FAX}"/>
										...
										<tr>
											...
											<td style="background: #EBEBEB;" align="right" class="ui-widget-content jqgrow ui-row-ltr">
												...
												<input type="hidden" name="CUST_LINKMAN_B" value="${customerInfoMap.NATU_LINKMAN}"/>
										...
										<tr>
											...
											<td style="background: #EBEBEB;" align="right" class="ui-widget-content jqgrow ui-row-ltr">
												...
												<input type="hidden" name="CUST_ZIP_B" value="${customerInfoMap.NATU_ZIP}"/>
										...
										<tr>
											...
											<td style="background: #EBEBEB;" align="right" class="ui-widget-content jqgrow ui-row-ltr">
												...
												<input type="hidden" name="CUST_ADDRESS_B" value="${customerInfoMap.HOME_ADDR}"/>
