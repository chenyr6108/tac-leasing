...
<html>
	...
	<div id="tabs" style="width: 1000px " align="center">
			<div id="main" class="zc_grid ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 980px">
		...
		<div id="tabs-3">
			...
			<input type="hidden" id="FOR_LOSS" name="FOR_LOSS" value="true"/>
			...
			<input type="hidden" id="forLoss" name="forLoss" value="true"/>
					...
					<TD style="text-align: center;" width="25%">${infor.LEASE_CODE}&nbsp;</TD>
						...
						<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title panel_table" id="table_3">
						       <tr class="ui-jqgrid-labels">
										<td align="left" colspan="10" style="text-align: center;">
								...
								<tr class="ui-jqgrid-labels">
									...
									<th class="ui-state-default ui-th-ltr zc_grid_head" style="width:4%;">编号</th>
...
<!-- 									<th class="ui-state-default ui-th-ltr zc_grid_head" style="width:13%;">复印件份数</th>-->
								...
								<c:forEach items="${insorupd}" var="item" varStatus="status" >
									...
									<c:if test="${fn:length(item.LOG) ne 0}">
										<tr id="cz001" class="ui-widget-content jqgrow ui-row-ltr">
											<td originrowspan="${fn:length(item.LOG)+1}" class="td_toggle" width="5%" onclick="expand('pactAffix3${item.REFI_ID}','${item.REFI_ID}','${prcd_id}');" style="cursor: pointer;">${status.count }</td>
											...
											<td width="20%">
												...
												<mSelect:multiSelect nameParams="ISSURELIST${status.count }${status.count }${status.count }" items="${infoTestList }"curIdVal="con.unitName" idParams="con.unitName" hasAllSelector="false" strInputValue="${item.ISSURE_REASON }"/>
											</td>
								...
								<tr id="cz001" class="ui-widget-content jqgrow ui-row-ltr">
									...
									<tr class="ui-jqgrid-labels">
										<th class="ui-state-default ui-th-ltr zc_grid_head" style="width:5%;"colspan="10"> 备注说明：</th>
									</tr>
									<tr class="ui-widget-content jqgrow ui-row-ltr">
										<td align="left" colspan="10"><c:forEach items="${rentFileSenderState}" var="item" varStatus="status">${item.HW_MEMO }<br></c:forEach></td>							
									</tr>									
