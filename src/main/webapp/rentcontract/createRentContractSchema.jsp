...
<table width="982" cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
	...
	<tr>
		...
		<td width="25%" class="ui-widget-content jqgrow ui-row-ltr">
			<input type="text" name="LEASE_PERIOD" readonly="readonly" onchange="changeField('LEASE_PERIOD',this);"  id="LEASE_PERIOD" value="${schema.LEASE_PERIOD }"
				style="width: 60px;">
		</td>
		...
		<td width="43%" class="ui-widget-content jqgrow ui-row-ltr">
			<select name="LEASE_TERM" onchange="changeField('LEASE_TERM',this);" id="LEASE_TERM">
				<option value="1" <c:if test="${schema.LEASE_TERM eq 1 }">selected="selected"</c:if>>
					月份
				</option>
				<option value="2" <c:if test="${schema.LEASE_TERM eq 2 }">selected="selected"</c:if>>
					双月
				</option>
				<option value="3" <c:if test="${schema.LEASE_TERM eq 3 }">selected="selected"</c:if>>
					季度
				</option>
				<option value="6" <c:if test="${schema.LEASE_TERM eq 6 }">selected="selected"</c:if>>
					半年
				</option>
				<option value="12" <c:if test="${schema.LEASE_TERM eq 12 }">selected="selected"</c:if>>
					年度
				</option>
			</select>
		</td>
	...
	<tr>
		...
		<td class="ui-widget-content jqgrow ui-row-ltr">
			<input type="text" name="PLEDGE_PRICE_RATE" onchange="changeField('PLEDGE_PRICE_RATE',this);" id="PLEDGE_PRICE_RATE" value="${schema.PLEDGE_PRICE_RATE }"
				style="width: 80px;">
			%
			<input type="text" name="PLEDGE_PRICE" onchange="changeField('PLEDGE_PRICE',this);" id="PLEDGE_PRICE" value="<fmt:formatNumber value="${schema.PLEDGE_PRICE }" type="currency" />"
				class="input_right">
		</td>
		<td class="ui-widget-content jqgrow ui-row-ltr">
			&nbsp;
	...
	<tr>
			...
			<td  class="ui-widget-content jqgrow ui-row-ltr">
				<input type="text" id="PLEDGE_AVE_PRICE" name="PLEDGE_AVE_PRICE" onchange="changeRZE();changePledgeRealPrice();"
			...
			<td   class="ui-widget-content jqgrow ui-row-ltr">
				<input type="text" id="PLEDGE_BACK_PRICE" name="PLEDGE_BACK_PRICE" 
		...
		<tr>
			...
			<td  class="ui-widget-content jqgrow ui-row-ltr">
				<input type="text" id="PLEDGE_LAST_PRICE" name="PLEDGE_LAST_PRICE" onchange="changeRZE();changePledgeRealPrice();"
					value="<fmt:formatNumber pattern='#,##0.00' value="${(empty schema.PLEDGE_LAST_PRICE?0:schema.PLEDGE_LAST_PRICE)+(empty schema.PLEDGE_LAST_PRICE_TAX?0:schema.PLEDGE_LAST_PRICE_TAX) }" />" style="text-align: right">
		...
		<tr>
			...
			<td  colspan="3"  class="ui-widget-content jqgrow ui-row-ltr">
				...
				<input type="text" id="PLEDGE_ENTER_CMPRICE" name="PLEDGE_ENTER_CMPRICE" style="text-align: right;" value="<fmt:formatNumber pattern='#,##0.00' value="${empty schema.PLEDGE_ENTER_CMPRICE?0:schema.PLEDGE_ENTER_CMPRICE}" />">&nbsp;&nbsp;税金&nbsp;
				<input type="text" name="PLEDGE_ENTER_CMRATE" style="text-align: right;" value="<fmt:formatNumber pattern='#,##0.00' value="${empty schema.PLEDGE_ENTER_CMRATE?0:schema.PLEDGE_ENTER_CMRATE}"/>">&nbsp;&nbsp;我司入供应商&nbsp;
				<input type="text" id="PLEDGE_ENTER_MCTOAG" name="PLEDGE_ENTER_MCTOAG"  style="text-align: right;" value="<fmt:formatNumber pattern='#,##0.00' value="${empty schema.PLEDGE_ENTER_MCTOAG?0:schema.PLEDGE_ENTER_MCTOAG}" />">&nbsp;&nbsp;税金&nbsp;
				<input type="text" id="PLEDGE_ENTER_MCTOAGRATE" name="PLEDGE_ENTER_MCTOAGRATE" style="text-align: right;" value="<fmt:formatNumber pattern='#,##0.00' value="${empty schema.PLEDGE_ENTER_MCTOAGRATE?0:schema.PLEDGE_ENTER_MCTOAGRATE}" />" onchange="judgeRatePrice();">
				<br>
				<!--<input type="radio" name="PLEDGE_ENTER_WAY" value="2" <c:if test="${schema.PLEDGE_ENTER_WAY eq 2 }">checked="checked"</c:if>>-->入供应商&nbsp;
				<input type="text" id="PLEDGE_ENTER_AG" name="PLEDGE_ENTER_AG"  style="text-align: right;" value="<fmt:formatNumber pattern='#,##0.00' value="${empty schema.PLEDGE_ENTER_AG?0:schema.PLEDGE_ENTER_AG }"/>">&nbsp;&nbsp;税金&nbsp;
				<input type="text" name="PLEDGE_ENTER_AGRATE"  onchange="update2222();" style="text-align: right;" value="<fmt:formatNumber pattern='#,##0.00' value="${empty schema.PLEDGE_ENTER_AGRATE?0:schema.PLEDGE_ENTER_AGRATE}" />">
			</td>
		</tr>
	<tr>
		<td class="ui-widget-content jqgrow ui-row-ltr">
		...
		<td class="ui-widget-content jqgrow ui-row-ltr">
		<!--  
			<input type="text" name="MANAGEMENT_FEE_RATE" onchange="changeField('MANAGEMENT_FEE_RATE',this);" value="${schema.MANAGEMENT_FEE_RATE}"
				id="MANAGEMENT_FEE_RATE" style="width: 80px;">
			%
			<input type="text" name="MANAGEMENT_FEE" onchange="changeField('MANAGEMENT_FEE',this);" id="MANAGEMENT_FEE" value="<fmt:formatNumber value="${schema.MANAGEMENT_FEE }" type="currency" />"
				class="input_right" >
		-->
		<input type="text" name="HEAD_HIRE_PERCENT"  onchange="changeField('HEAD_HIRE_PERCENT',this);"  id="HEAD_HIRE_PERCENT" value="${schema.HEAD_HIRE_PERCENT }"
				style="width: 80px;">
			%
			<input type="text" name="HEAD_HIRE" id="HEAD_HIRE"  onchange="changeField('HEAD_HIRE',this);"
				class="input_right" 
				...
				<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title" id="feeListRZETable">
							...
							<c:forEach items="${feeListRZE }" var="item"  varStatus="status">
								...
								<input type="text" name="${item.CREATE_FILED_NAME }" id="${item.CREATE_FILED_NAME }" 
										 value="${empty item.FEE?0:item.FEE }"  style="text-align: right" feeListRZE="feeListRZE" readonly="readonly" >来源：<select name="${item.CREATE_FILED_NAME }_select" disabled><c:forEach items="${feeSourceList }" var="item11"  varStatus="status">
...
<!-- Add by Michael 2012 01/14 费用参数化 -->		
	<tr>
		...
		<td class="ui-widget-content jqgrow ui-row-ltr">
			<input type="text" name="FLOAT_RATE" onchange="changeField('FLOAT_RATE',this);" id="FLOAT_RATE" value="${schema.FLOAT_RATE }"
		...
		<td class="ui-widget-content jqgrow ui-row-ltr">
			<input type="text" name="YEAR_INTEREST" onchange="changeField('YEAR_INTEREST',this);"  id="YEAR_INTEREST" value="${schema.YEAR_INTEREST }"
				style="width: 80px;">
			% &nbsp;&nbsp;
			<input type="radio" name="YEAR_INTEREST_TYPE" value="1" <c:if test="${schema.YEAR_INTEREST_TYPE eq 1}">checked="checked"</c:if>>
			&nbsp;浮动 &nbsp;&nbsp;
			<input type="radio" name="YEAR_INTEREST_TYPE" value="2" <c:if test="${schema.YEAR_INTEREST_TYPE eq 2}">checked="checked"</c:if>>
			&nbsp;固定
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="ui-widget-content jqgrow ui-row-ltr">
			<input type="text" name="LEASE_RZE" readonly="readonly" id="LEASE_RZE" value="<fmt:formatNumber value="${schema.LEASE_RZE }" type="currency" />"
	...
	<tr>
		...
		<td class="ui-widget-content jqgrow ui-row-ltr">
			<select name="PAY_WAY" id="PAY_WAY" onchange="changeField('PAY_WAY',this);">
				<option value="-1">
					--请选择--
				</option>
				<c:forEach items="${payWays}" var="item">
					<option value="${item.CODE }" <c:if test="${ schema.PAY_WAY eq item.CODE }"> selected="selected"</c:if>>
						${item.FLAG }
					</option>
				</c:forEach>
			</select>
		...
		<td class="ui-widget-content jqgrow ui-row-ltr">
			<input type="text" name="START_DATE" id="START_DATE" value="<fmt:formatDate value="${schema.START_DATE }" pattern="yyyy-MM-dd" />"
				style="width: 100px;" readonly="readonly" ><!-- onchange="checkTime()">  -->
		</td>
	</tr>
	<tr>
		<td class="ui-widget-content jqgrow ui-row-ltr">
		...
		<td class="ui-widget-content jqgrow ui-row-ltr">
			<input type="text" name="BUSINESS_TRIP_PRICE"  value="<fmt:formatNumber value="${schema.BUSINESS_TRIP_PRICE }" type="currency" />"
	...
	<tr>
		...
		<td colspan="3" class="ui-widget-content jqgrow ui-row-ltr">
			<input type="text" name="EQUPMENT_ADDRESS" id="EQUPMENT_ADDRESS" value="${schema.EQUPMENT_ADDRESS }"
				style="width: 600px;">
		</td>
	</tr>
	<tr>
		...
		<td class="ui-widget-content jqgrow ui-row-ltr" colspan="3">
			<select name="DEAL_WAY" id="DEAL_WAY">
				...
				<c:forEach items="${dealWays}" var="item">
					<option value="${item.CODE }" <c:if test="${ schema.DEAL_WAY eq item.CODE }"> selected="selected"</c:if>>
						${item.FLAG }
					</option>
				</c:forEach>
			</select>
	...
	<tr>
		...
		<input type="hidden" name="INSURE_REBATE_RATE" id="INSURE_REBATE_RATE" value="0.00"><input type="hidden" name="BUY_INSURANCE_WAY" id="BUY_INSURANCE_WAY" value="0"></td>
		<td class="ui-widget-content jqgrow ui-row-ltr">
			<input type="radio" name="BUY_INSURANCE_TIME" value="1"  <c:if test="${ schema.BUY_INSURANCE_TIME != 2 }">checked="checked"</c:if>>
			&nbsp;全年购买 &nbsp;&nbsp;
			<input type="radio" name="BUY_INSURANCE_TIME" value="2" <c:if test="${ schema.BUY_INSURANCE_TIME eq 2 }">checked="checked"</c:if>>
			&nbsp;分年购买
		</td>
	</tr>
	<!-- <tr>
