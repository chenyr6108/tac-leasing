...
<div id='case_report' class='portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'>
	<div class="portlet-header ui-widget-header ui-corner-all">
		<span class="ui-icon ui-icon-closethick" onclick="deleteDIV(this,'case_report');" title="点击删除导航"></span>案况统计表
		<!-- 
		<br>
	...
	<div class="portlet-content">
		<div class="zc_grid ui-jqgrid ui-widget ui-widget-content ui-corner-all" id="main">
       			...
       			<div class="ui-state-default ui-jqgrid-hdiv">&nbsp;&nbsp;&nbsp;单位:K
