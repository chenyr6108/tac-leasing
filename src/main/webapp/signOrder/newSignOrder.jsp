...
<body>
	<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px;">
		<span id="addDemandTitle1" class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;">&nbsp;&nbsp;新增签办单</span>
	</div>
	<br>
	...
	<form action="${ctx}/servlet/defaultDispatcher" name="form1" id="form1" method="post" enctype="multipart/form-data">
		<input type="hidden" id="__action" name="__action" value="signOrderCommand.insertSignOrders">
		...
		<c:if test="${empty addType }">
			<input type="hidden" value="" id="chooseCodes" name="chooseCodes" />
			<input type="hidden" value="${companyCode }" id="companyCode" name="companyCode" />
			<input type="hidden" value="${departmentCode }" id="departmentCode" name="departmentCode" />
		</c:if>
									...
									<td>
										<table cellspacing="0" cellpadding="0" border="0" class="panel_table" id="modifyOrderTable">
											<tr id="orderTr">
												...
												<td style="height: 30px; width:22%;text-align:center;">${s_employeeName}</td>
												...
												<th style="height: 30px;width:15%"><!-- 字： --></th>
												<td style="height: 30px;text-align:center;"><%-- ${departmentCode} --%></td>
											</tr>
											<tr>
												<th style="height: 30px; width:15%">事由：</th>
												<td colspan="5" align="left" style="height: 30px;">
													<input style="width:60%;height:28px;" maxlength="40" type="text" id="SUMMARY" name="SUMMARY" value="${SUMMARY}" />
											...
											<tr>
												...
												<td colspan="5" style="height: 100px;">
													<textarea rows="14" cols="100" style="width:100%" id="content" name="content">${content }</textarea>
												</td>
											</tr>
											<c:if test="${empty addType }">
												<tr>
