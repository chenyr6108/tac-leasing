 ...
 <script type="text/javascript">
	 ...
	 $(function (){
 		...
 		function viewReceipt(){
 			location.href="../servlet/defaultDispatcher?__action=rentFinanceCommand.queryDirectLeaseList";
 		}
 </script>
</head>
<body>
	<form action="../servlet/defaultDispatcher" name="form1" id="form1" method="post">
		<input type="hidden" id="__action" name="__action" value="rentFinanceCommand.viewLog" />   		
		<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="height: 30px">
			<span class="ui-jqgrid-title" style="line-height: 30px; font-size: 15px;">&nbsp;直租发票收据打印记录</span>
		</div>
	 	...
	 	<div class="zc_grid_body jqgrowleft">
			...
			<div class="ui-state-default ui-jqgrid-hdiv ">
				<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title" id="#table1"> 
					<tr>
						<td>
							<input type="button" class="ui-state-default ui-corner-all" id="But" value="返回打印列表" name="Log" onclick="viewReceipt();">
						</td>
				...
				<table class="grid_table">
					...
					<c:forEach items="${dw.resultList}" var="item" varStatus="status">
						<tr>
							...
							<td style="text-align: center;"><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${item.LOGCREATEDATE }" />&nbsp;</td>	
