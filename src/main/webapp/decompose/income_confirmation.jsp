...
function expand4(FIIN_ID){	
    $("#pactAffix4"+FIIN_ID).toggle(function(){
	...
	<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-htable zc_grid_title">
		...
		<c:forEach items="${dw.rs}" var="income" varStatus="status">
			<tr	class="ui-widget-content jqgrow ui-row-ltr">	
				...
				<td style="text-align: center;" <c:if test="${income.QTY >0 }">onclick="expand4('${income.FIIN_ID}');"</c:if>>&nbsp;<c:if test="${income.QTY >0 }"><img src="${ctx }/images/attach.jpg" title="已有水单上传" style="cursor: pointer;">${income.QTY }份</c:if></td>			
				...
				<td style="text-align: center;">${income.DEPOSE_CUSTOMER }&nbsp;</td>
			...
			<tr>
				<td style="text-align: center;" colspan="10"  align="center">
					<div id="pactAffix4${income.FIIN_ID}" align="center" style="margin-left:15px ;margin-right:15px;margin-top:10px;margin-bottom:20px;  display: none; width: 40%">
			...
			<tr>
				<td style="text-align: center;" colspan="10" align="center">
					<div id="pactAffix4_${income.FIIN_ID}" align="center"
