...
<html>
  ...
  <body>
		<form action="../servlet/defaultDispatcher" name="form2" id="form2" method="post">
			...
			<TR>
				<TD class="ui-widget-content jqgrow ui-row-ltr">客户姓名:</TD>
			...
			<c:choose>
				...
				<c:otherwise>		
						<c:if test="${ty_code != xuanList.TYPE_CODE}">
							<tr><td class="ui-widget-content jqgrow ui-row-ltr" colspan="5" align="right">小  计：<input width="10%" type="text" readonly="readonly" style="border-top-style:none;   border-left-style:none;   border-right-style:none;border-bottom-style:none;text-align: center" id="x_sum${xuanList.TYPE_CODE-1}" name="x_sum">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>					
						</c:if>
						<c:set var="ty_code" value="${xuanList.TYPE_CODE}"></c:set>
				</c:otherwise>
			</c:choose>				
			...
			<tr align="right" ><td align="right"class="ui-widget-content jqgrow ui-row-ltr" colspan="5">小  计：<input  readonly="readonly" style="border-top-style:none;   border-left-style:none;   border-right-style:none;border-bottom-style:none;text-align: center"type="text" id="x_sum${ty_code}" name="x_sum">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
			<tr align="right" ><td  class="ui-state-default ui-th-ltr zc_grid_head" align="right" colspan="5">合  计：<input readonly="readonly" style="border-top-style:none;   border-left-style:none;   border-right-style:none;border-bottom-style:none;text-align: center" type="text" id="s_sum" name="s_sum">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>						
			</TABLE>
